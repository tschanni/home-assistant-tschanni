function e(e, t, i, r) {
  var s,
    a = arguments.length,
    n =
      a < 3 ? t : null === r ? (r = Object.getOwnPropertyDescriptor(t, i)) : r;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
    n = Reflect.decorate(e, t, i, r);
  else
    for (var o = e.length - 1; o >= 0; o--)
      (s = e[o]) && (n = (a < 3 ? s(n) : a > 3 ? s(t, i, n) : s(t, i)) || n);
  ...
  : (e) =>
      e instanceof CSSStyleSheet
        ? ((e) => {
            ...
            return ((e) => new n("string" == typeof e ? e : e + "", void 0, s))(
              t,
            );
          })(e)
        : e;
...
const c = window,
  ...
  f = (e, t) => t !== e && (t == t || e == e),
  p = { attribute: !0, type: String, converter: m, reflect: !1, hasChanged: f },
  y = "finalized";
        ...
        r
          ...
          : t.forEach((t) => {
              const r = document.createElement("style"),
                s = i.litNonce;
              void 0 !== s && r.setAttribute("nonce", s),
      ...
      const e = r.getPropertyOptions(s),
        a =
          "function" == typeof e.converter
            ...
            : m;
      (this._$El = s),
        (this[s] = a.fromAttribute(t, e.type)),
        (this._$El = null);
    }
  }
  requestUpdate(e, t, i) {
...
const w = window,
  v = w.trustedTypes,
  k = v ? v.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
  x = "$lit$",
  ...
  z = new WeakMap(),
  L = _.createTreeWalker(_, 129, null, !1);
function F(e, t) {
  if (!Array.isArray(e) || !e.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
  return void 0 !== k ? k.createHTML(t) : t;
}
const P = (e, t) => {
  const i = e.length - 1,
    r = [];
  ...
  for (let t = 0; t < i; t++) {
    ...
    let o,
      ...
      c = -1,
      d = 0;
    for (; d < i.length && ((n.lastIndex = d), (l = n.exec(i)), null !== l); )
      (d = n.lastIndex),
        n === Z
          ? "!--" === l[1]
            ? (n = C)
          ...
          ? ">" === l[0]
            ...
            : ((c = n.lastIndex - l[2].length),
              (o = l[1]),
              (n = void 0 === l[3] ? U : '"' === l[3] ? G : V))
          : n === G || n === V
          ? (n = U)
          : n === C || n === B
          ? (n = Z)
          : ((n = U), (s = void 0));
    const u = n === U && e[t + 1].startsWith("/>") ? " " : "";
    a +=
      n === Z
        ? i + S
        : c >= 0
        ? (r.push(o), i.slice(0, c) + x + i.slice(c) + T + u)
        : i + T + (-2 === c ? (r.push(void 0), t) : u);
  }
  return [F(e, a + (e[i] || "<?>") + (2 === t ? "</svg>" : "")), r];
};
class H {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    for (; null !== (r = L.nextNode()) && o.length < n; ) {
      if (1 === r.nodeType) {
        if (r.hasAttributes()) {
          const e = [];
          for (const t of r.getAttributeNames())
            if (t.endsWith(x) || t.startsWith(T)) {
              const i = c[a++];
              if ((e.push(t), void 0 !== i)) {
                const e = r.getAttribute(i.toLowerCase() + x).split(T),
                  t = /([.?@])?(.*)/.exec(i);
                o.push({
                  type: 1,
                  index: s,
        ...
        if (r.data === M) o.push({ type: 2, index: s });
        else {
          let e = -1;
          for (; -1 !== (e = r.data.indexOf(T, e + 1)); )
            o.push({ type: 7, index: s }), (e += T.length - 1);
        }
      s++;
    }
  }
  ...
  return (
    (null == l ? void 0 : l.constructor) !== c &&
      (null === (a = null == l ? void 0 : l._$AO) ||
        void 0 === a ||
        a.call(l, !1),
      void 0 === c ? (l = void 0) : ((l = new c(e)), l._$AT(e, i, r)),
      void 0 !== r
        ? ((null !== (n = (o = i)._$Co) && void 0 !== n ? n : (o._$Co = []))[
            r
          ] = l)
        : (i._$Cl = l)),
    void 0 !== l && (t = W(e, l._$AS(e, t.values), l, r)),
    t
  );
}
class q {
  ...
  u(e) {
    ...
    for (; void 0 !== l; ) {
      if (n === l.index) {
        let t;
        2 === l.type
          ? (t = new R(a, a.nextSibling, this, e))
          : 1 === l.type
          ? (t = new l.ctor(a, l.name, l.strings, this, e))
          : 6 === l.type && (t = new ee(a, this, e)),
          this._$AV.push(t),
          (l = r[++o]);
      }
      n !== (null == l ? void 0 : l.index) && ((a = L.nextNode()), n++);
    }
    return (L.currentNode = _), s;
  }
  v(e) {
    let t = 0;
...
class R {
  constructor(e, t, i, r) {
    ...
    (this.type = 2),
      ...
      (this.options = r),
      (this._$Cp =
        null === (s = null == r ? void 0 : r.isConnected) || void 0 === s || s);
  }
  get _$AU() {
    var e, t;
    return null !==
  ...
  _(e) {
    this._$AH !== I && O(this._$AH)
      ? (this._$AA.nextSibling.data = e)
      : this.$(_.createTextNode(e)),
      (this._$AH = e);
  }
  g(e) {
    var t;
    const { values: i, _$litType$: r } = e,
      s =
        "number" == typeof r
          ? this._$AC(e)
          : (void 0 === r.el &&
              (r.el = H.createElement(F(r.h, r.h[0]), this.options)),
            r);
  ...
  _$AC(e) {
    ...
    return void 0 === t && z.set(e.strings, (t = new H(e))), t;
  }
  T(e) {
    ...
    for (const s of e)
      r === t.length
        ? t.push((i = new R(this.k(N()), this.k(N()), this, this.options)))
        : (i = t[r]),
        i._$AI(s),
        r++;
  ...
  _$AI(e, t = this, i, r) {
    ...
    if (void 0 === s)
      ...
      for (e = s[0], n = 0; n < s.length - 1; n++)
        (o = W(this, r[i + n], t, n)),
          o === j && (o = this._$AH[n]),
          a || (a = !O(o) || o !== this._$AH[n]),
          o === I ? (e = I) : e !== I && (e += (null != o ? o : "") + s[n + 1]),
          (this._$AH[n] = o);
    }
    a && !r && this.j(e);
  }
...
class X extends Y {
  ...
  _$AI(e, t = this) {
    var i;
    if ((e = null !== (i = W(this, e, t, 0)) && void 0 !== i ? i : I) === j)
      return;
    const r = this._$AH,
      s =
        (e === I && r !== I) ||
...
(se.finalized = !0),
  (se._$litElement$ = !0),
  null === (ie = globalThis.litElementHydrateSupport) ||
    void 0 === ie ||
    ie.call(globalThis, { LitElement: se });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */ function le(e) {
  return (t, i) => (void 0 !== i ? oe(e, t, i) : ne(e, t));
  /**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
...
var me = ["closed", "locked", "off"],
  ...
  ye = function (e, t, i, r) {
    if (
      (r || (r = { action: "more-info" }),
      !r.confirmation ||
        (r.confirmation.exemptions &&
          r.confirmation.exemptions.some(function (e) {
            return e.user === t.user.id;
          })) ||
        (pe("warning"),
        confirm(
          r.confirmation.text || "Are you sure you want to " + r.action + "?",
        )))
    )
      switch (r.action) {
        case "more-info":
          ...
          r.navigation_path &&
            (function (e, t, i) {
              void 0 === i && (i = !1),
                ...
                fe(window, "location-changed", { replace: i });
            })(0, r.navigation_path);
          break;
        case "url":
          ...
          i.entity &&
            ((function (e, t) {
              (function (e, t, i) {
                ...
                e.callService(a, r, { entity_id: t });
              })(e, t, me.includes(e.states[t].state));
            })(t, i.entity),
            pe("success"));
          break;
        case "call-service":
          if (!r.service) return void pe("failure");
          var s = r.service.split(".", 2);
          t.callService(s[0], s[1], r.service_data, r.target), pe("success");
          break;
        case "fire-dom-event":
          fe(e, "ll-custom", r);
      }
...
class xe extends HTMLElement {
  ...
  bind(e, t) {
    ...
    const i = (e) => {
        ...
        this.held = !1;
        const r =
            null !== (t = e.pageX) && void 0 !== t ? t : e.touches[0].pageX,
          s = null !== (i = e.pageY) && void 0 !== i ? i : e.touches[0].pageY;
        this.timer = window.setTimeout(() => {
          this.startAnimation(r, s), (this.held = !0);
        }, this.holdTime);
      },
      r = (i) => {
        i.preventDefault(),
          (["touchend", "touchcancel"].includes(i.type) &&
            ...
            (this.timer = void 0),
            this.held
              ? fe(e, "action", { action: "hold" })
              : t.hasDoubleClick
              ? ("click" === i.type && i.detail < 2) || !this.dblClickTimeout
                ? (this.dblClickTimeout = window.setTimeout(() => {
                    (this.dblClickTimeout = void 0),
                      fe(e, "action", { action: "tap" });
                  }, 250))
                : (clearTimeout(this.dblClickTimeout),
                  (this.dblClickTimeout = void 0),
                  fe(e, "action", { action: "double_tap" }))
              : fe(e, "action", { action: "tap" }));
      };
  ...
  startAnimation(e, t) {
    Object.assign(this.style, { left: `${e}px`, top: `${t}px`, display: null }),
      (this.ripple.disabled = !1),
      (this.ripple.active = !0),
      (this.ripple.unbounded = !0);
  }
  stopAnimation() {
    (this.ripple.active = !1),
      (this.ripple.disabled = !0),
      (this.style.display = "none");
  }
}
customElements.get("action-handler-clock-weather") ||
  customElements.define("action-handler-clock-weather", xe);
const Te = (e, t) => {
    const i = (() => {
      const e = document.body;
      if (e.querySelector("action-handler-clock-weather"))
        return e.querySelector("action-handler-clock-weather");
      const t = document.createElement("action-handler-clock-weather");
...
var Se = {
    ...
    fog: "Мъгла",
    hail: "Градушка",
    lightning: "Гръмотевични бури",
    "lightning-rainy": "Дъждовни гръмотевични бури",
    partlycloudy: "Частична облачност",
    pouring: "Пороен дъжд",
    rainy: "Дъждовно",
    snowy: "Сняг",
    "snowy-rainy": "Суграшица",
    sunny: "Слънчево",
    windy: "Ветровито",
    "windy-variant": "Силен вятър",
    exceptional: "Изключително",
  },
  _e = { 1: "Пн", 2: "Вт", 3: "Ср", 4: "Чт", 5: "Пт", 6: "Сб", 7: "Нд" },
  Ne = { aqi: "AQI", humidity: "Влажност", "feels-like": "Усеща се като" },
  Oe = { weather: Se, day: _e, misc: Ne },
  Ae = Object.freeze({
    __proto__: null,
    day: _e,
    default: Oe,
  ...
  $e = {
    ...
    sunny: "Solrig",
    windy: "Blæsende",
    "windy-variant": "Stærk vind",
    exceptional: "Kaos",
  },
  Ze = { 1: "Man", 2: "Tir", 3: "Ons", 4: "Tor", 5: "Fre", 6: "Lør", 7: "Søn" },
  Ce = { aqi: "AQI", humidity: "fugtighed", "feels-like": "Feels like" },
  Be = { weather: $e, day: Ze, misc: Ce },
  Ue = Object.freeze({
    __proto__: null,
    day: Ze,
    default: Be,
  ...
  Ge = { 1: "Dl.", 2: "Dt.", 3: "Dc.", 4: "Dj.", 5: "Dv.", 6: "Ds.", 7: "Dg." },
  Ee = { aqi: "AQI", humidity: "humitat", "feels-like": "Sensació tèrmica" },
  De = { weather: Ve, day: Ge, misc: Ee },
  je = Object.freeze({
    __proto__: null,
    day: Ge,
    default: De,
  ...
  ze = { 1: "Po", 2: "Út", 3: "St", 4: "Čt", 5: "Pá", 6: "So", 7: "Ne" },
  Le = { aqi: "AQI", humidity: "vlhkost", "feels-like": "pocitová teplota" },
  Fe = { weather: Ie, day: ze, misc: Le },
  Pe = {
    "clear-night": "klar",
    cloudy: "bewölkt",
    fog: "Nebel",
    ...
    sunny: "sonnig",
    windy: "windig",
    "windy-variant": "starker Wind",
    exceptional: "Unwetter",
  },
  He = { 1: "Mo", 2: "Di", 3: "Mi", 4: "Do", 5: "Fr", 6: "Sa", 7: "So" },
  We = { aqi: "AQI", humidity: "Luftfeuchtigkeit", "feels-like": "Gefühlt" },
  qe = { weather: Pe, day: He, misc: We },
  Re = {
    "clear-night": "Καθαρός",
  ...
  Ye = { 1: "Δευ", 2: "Τρί", 3: "Τετ", 4: "Πεμ", 5: "Παρ", 6: "Σαβ", 7: "Κυρ" },
  Je = { aqi: "AQI", humidity: "υγρασία", "feels-like": "Feels like" },
  Qe = { weather: Re, day: Ye, misc: Je },
  Ke = {
    "clear-night": "Clear",
    cloudy: "Cloudy",
    fog: "Fog",
    ...
    "lightning-rainy": "Rainy thunderstorms",
    ...
    sunny: "Sunny",
    windy: "Windy",
    "windy-variant": "Strong wind",
    exceptional: "Exceptional",
  },
  Xe = { 1: "Mon", 2: "Tue", 3: "Wed", 4: "Thu", 5: "Fri", 6: "Sat", 7: "Sun" },
  et = { aqi: "AQI", humidity: "Humidity", "feels-like": "Feels like" },
  tt = { weather: Ke, day: Xe, misc: et },
  it = {
    ...
    sunny: "Soleado",
    windy: "Viento",
    "windy-variant": "Fuerte viento",
    exceptional: "Caos",
  },
  rt = { 1: "Lun", 2: "Mar", 3: "Mie", 4: "Jue", 5: "Vie", 6: "Sab", 7: "Dom" },
  st = { aqi: "AQI", humidity: "humedad", "feels-like": "Sensación térmica" },
  at = { weather: it, day: rt, misc: st },
  nt = {
    "clear-night": "Selge",
    cloudy: "Pilvine",
    fog: "Udu",
  ...
  ot = { 1: "E", 2: "T", 3: "K", 4: "N", 5: "R", 6: "L", 7: "P" },
  lt = { aqi: "AQI", humidity: "niiskus", "feels-like": "Feels like" },
  ct = { weather: nt, day: ot, misc: lt },
  dt = {
    "clear-night": "Selkeää",
    cloudy: "Pilvistä",
    fog: "Sumua",
    ...
    pouring: "Voimakasta vesisadetta",
    rainy: "Vesisadetta",
    snowy: "Lumisadetta",
    "snowy-rainy": "Räntäsadetta",
    sunny: "Selkeää",
    windy: "Tuulista",
    "windy-variant": "Voimakasta tuulta",
    exceptional: "Poikkeuksellista",
  },
  ut = { 1: "Ma", 2: "Ti", 3: "Ke", 4: "To", 5: "Pe", 6: "La", 7: "Su" },
  ht = { aqi: "AQI", humidity: "kosteus", "feels-like": "Feels like" },
  mt = { weather: dt, day: ut, misc: ht },
  ft = {
    "clear-night": "Dégagé",
    cloudy: "Nuageux",
    fog: "Brouillard",
  ...
  pt = { 1: "Lun", 2: "Mar", 3: "Mer", 4: "Jeu", 5: "Ven", 6: "Sam", 7: "Dim" },
  yt = { aqi: "AQI", humidity: "humidité", "feels-like": "Ressentie" },
  bt = { weather: ft, day: pt, misc: yt },
  gt = {
    "clear-night": "בהיר",
    cloudy: "מעונן",
    fog: "ערפל",
    hail: "ברד",
    lightning: "סופות רעמים",
    "lightning-rainy": "סופות רעמים גשומות",
  ...
  vt = { aqi: "AQI", humidity: "לחות", "feels-like": "מרגיש כמו" },
  kt = { weather: gt, day: wt, misc: vt },
  xt = {
    "clear-night": "Tiszta",
    cloudy: "Felhős",
    fog: "Ködös",
    ...
    rainy: "Esős",
    snowy: "Havazás",
    "snowy-rainy": "Havaseső, ónoseső",
    sunny: "Napos",
    windy: "Szeles",
    "windy-variant": "Erős szél",
    exceptional: "Kivételes",
  },
  Tt = { 1: "H", 2: "K", 3: "Sze", 4: "Cs", 5: "P", 6: "Szo", 7: "V" },
  Mt = { aqi: "AQI", humidity: "páratartalom", "feels-like": "Feels like" },
  St = { weather: xt, day: Tt, misc: Mt },
  _t = {
    "clear-night": "Cerah",
    cloudy: "Berawan",
    fog: "Berkabut",
    hail: "Hujan es",
    lightning: "Petir",
    "lightning-rainy": "Hujan petir",
    partlycloudy: "Cerah berawan",
    pouring: "Hujan deras",
    rainy: "Hujan",
    snowy: "Salju",
    "snowy-rainy": "Hujan salju",
    sunny: "Cerah",
    windy: "Berangin",
    "windy-variant": "Berangin kencang",
    exceptional: "Badai",
  },
  Nt = { 1: "Sen", 2: "Sel", 3: "Rab", 4: "Kam", 5: "Jum", 6: "Sab", 7: "Min" },
  Ot = { aqi: "AQI", humidity: "Kelembapan", "feels-like": "Terasa seperti" },
  At = { weather: _t, day: Nt, misc: Ot },
  $t = {
  ...
  Zt = { 1: "Mán", 2: "Þri", 3: "Mið", 4: "Fim", 5: "Fös", 6: "Lau", 7: "Sun" },
  Ct = { aqi: "AQI", humidity: "raki", "feels-like": "Feels like" },
  Bt = { weather: $t, day: Zt, misc: Ct },
  Ut = {
    "clear-night": "Sereno",
    cloudy: "Nuvoloso",
    fog: "Nebbia",
    ...
    exceptional: "Tempesta",
  },
  Vt = { 1: "Lun", 2: "Mar", 3: "Mer", 4: "Gio", 5: "Ven", 6: "Sab", 7: "Dom" },
  Gt = { aqi: "AQI", humidity: "umidità", "feels-like": "Percepita" },
  Et = { weather: Ut, day: Vt, misc: Gt },
  Dt = {
    "clear-night": "맑음",
    cloudy: "구름많음",
    fog: "안개",
    ...
    sunny: "맑음",
    windy: "바람",
    "windy-variant": "매우 강한 바람",
    exceptional: "예외",
  },
  jt = { 1: "월", 2: "화", 3: "수", 4: "목", 5: "금", 6: "토", 7: "일" },
  It = { aqi: "대기환경지수", humidity: "습도", "feels-like": "체감온도" },
  zt = { weather: Dt, day: jt, misc: It },
  Lt = {
    "clear-night": "kloer",
    cloudy: "bedeckt",
    fog: "Niwwel",
  ...
  Ft = { 1: "Mé", 2: "Dë", 3: "Më", 4: "Do", 5: "Fr", 6: "Sa", 7: "So" },
  Pt = { aqi: "AQI", humidity: "Loftfiichtegkeet", "feels-like": "Gefillt" },
  Ht = { weather: Lt, day: Ft, misc: Pt },
  Wt = {
    "clear-night": "Giedra",
    cloudy: "Debesuota",
    fog: "Rūkas",
    hail: "Kruša",
    lightning: "Perkūnija",
    "lightning-rainy": "Perkūnija su lietumi",
    ...
    sunny: "Saulėta",
    windy: "Vėjuota",
    "windy-variant": "Stiprus vėjas",
    exceptional: "Audra",
  },
  qt = { 1: "Pr", 2: "An", 3: "Tr", 4: "Kt", 5: "Pn", 6: "Št", 7: "Sk" },
  Rt = { aqi: "AQI", humidity: "drėgmė", "feels-like": "Feels like" },
  Yt = { weather: Wt, day: qt, misc: Rt },
  Jt = {
    "clear-night": "Klart",
    cloudy: "Overskyet",
    fog: "Tåke",
    ...
    sunny: "Sol",
    windy: "Vindfullt",
    "windy-variant": "Sterk vind",
    exceptional: "Storm",
  },
  Qt = { 1: "Man", 2: "Tir", 3: "Ons", 4: "Tor", 5: "Fre", 6: "Lør", 7: "Søn" },
  Kt = { aqi: "AQI", humidity: "fuktighet", "feels-like": "Feels like" },
  Xt = { weather: Jt, day: Qt, misc: Kt },
  ei = {
    "clear-night": "Helder",
    cloudy: "Bewolkt",
    fog: "Mistig",
  ...
  ti = { 1: "Ma", 2: "Di", 3: "Wo", 4: "Do", 5: "Vr", 6: "Za", 7: "Zo" },
  ii = {
    aqi: "AQI",
    humidity: "Vochtigheid",
    "feels-like": "Gevoelstemperatuur",
  },
  ri = { weather: ei, day: ti, misc: ii },
  si = {
  ...
  ni = { aqi: "AQI", humidity: "wilgotność", "feels-like": "Odczuwalne" },
  oi = { weather: si, day: ai, misc: ni },
  li = {
    "clear-night": "Céu limpo, sem nuvens",
    cloudy: "Nublado",
    fog: "Nevoeiro",
    hail: "Granizo",
    lightning: "Raios",
    ...
    sunny: "Ensolarado",
    windy: "Ventania",
    "windy-variant": "Ventania forte",
    exceptional: "Excepcional",
  },
  ci = { 1: "Seg", 2: "Ter", 3: "Qua", 4: "Qui", 5: "Sex", 6: "Sáb", 7: "Dom" },
  di = { aqi: "AQI", humidity: "umidade", "feels-like": "Feels like" },
  ui = { weather: li, day: ci, misc: di },
  hi = {
    "clear-night": "Céu limpo, sem nuvens",
    cloudy: "Nublado",
    fog: "Nevoeiro",
  ...
  mi = { 1: "Seg", 2: "Ter", 3: "Qua", 4: "Qui", 5: "Sex", 6: "Sáb", 7: "Dom" },
  fi = { aqi: "AQI", humidity: "humidade", "feels-like": "Sensação térmica" },
  pi = { weather: hi, day: mi, misc: fi },
  yi = {
    "clear-night": "Senin",
    cloudy: "Innorat",
    fog: "Ceata",
  ...
  bi = { 1: "Lun", 2: "Mar", 3: "Mie", 4: "Joi", 5: "Vin", 6: "Sam", 7: "Dum" },
  gi = { aqi: "AQI", humidity: "umiditate", "feels-like": "Feels like" },
  wi = { weather: yi, day: bi, misc: gi },
  vi = {
    "clear-night": "Ясно",
    cloudy: "Облачно",
    fog: "Туман",
  ...
  ki = { 1: "Пн", 2: "Вт", 3: "Ср", 4: "Чт", 5: "Пт", 6: "Сб", 7: "Вс" },
  xi = { aqi: "AQI", humidity: "влажность", "feels-like": "Ощущается как" },
  Ti = { weather: vi, day: ki, misc: xi },
  Mi = {
    ...
    hail: "Krupobitie",
    lightning: "Búrky",
    "lightning-rainy": "Búrky s dažďom",
    ...
    sunny: "Slnečno",
    windy: "Veterno",
    "windy-variant": "Prudký vietor",
    exceptional: "Neobyčajné počasie (Chaos)",
  },
  Si = { 1: "Pon", 2: "Uto", 3: "Str", 4: "Štv", 5: "Pia", 6: "Sob", 7: "Ned" },
  _i = { aqi: "AQI", humidity: "vlhkosť", "feels-like": "pocitová teplota" },
  Ni = { weather: Mi, day: Si, misc: _i },
  Oi = {
    "clear-night": "Jasno",
    cloudy: "Oblačno",
    fog: "Megla",
    hail: "Toča",
    lightning: "Nevihte",
    "lightning-rainy": "Nevihte z dežjem",
    ...
    sunny: "Sončno",
    windy: "Vetrovno",
    "windy-variant": "Močan veter",
    exceptional: "Izjemno vreme",
  },
  Ai = { 1: "Pon", 2: "Tor", 3: "Sre", 4: "Čet", 5: "Pet", 6: "Sob", 7: "Ned" },
  $i = { aqi: "AQI", humidity: "vlažnost", "feels-like": "Feels like" },
  Zi = { weather: Oi, day: Ai, misc: $i },
  Ci = {
    "clear-night": "Ведро",
    cloudy: "Облачно",
    fog: "Магла",
  ...
  Bi = { 1: "Пон", 2: "Уто", 3: "Сре", 4: "Чет", 5: "Пет", 6: "Суб", 7: "Нед" },
  Ui = { aqi: "AQI", humidity: "Влажност", "feels-like": "Feels like" },
  Vi = { weather: Ci, day: Bi, misc: Ui },
  Gi = {
    "clear-night": "Vedro",
    cloudy: "Oblačno",
    fog: "Magla",
    ...
    "lightning-rainy": "Kiša uz grmljavinu",
    ...
    sunny: "Sunčano",
    windy: "Vetar",
    "windy-variant": "Jak vetar",
    exceptional: "Izuzetno",
  },
  Ei = { 1: "Pon", 2: "Uto", 3: "Sre", 4: "Čet", 5: "Pet", 6: "Sub", 7: "Ned" },
  Di = { aqi: "AQI", humidity: "Vlažnost", "feels-like": "Feels like" },
  ji = { weather: Gi, day: Ei, misc: Di },
  Ii = {
    ...
    sunny: "Soligt",
    windy: "Blåsigt",
    "windy-variant": "Stark blåst",
    exceptional: "Exceptionellt",
  },
  zi = { 1: "Mån", 2: "Tis", 3: "Ons", 4: "Tor", 5: "Fre", 6: "Lör", 7: "Sön" },
  Li = { aqi: "AQI", humidity: "fuktighet", "feels-like": "Känns som" },
  Fi = { weather: Ii, day: zi, misc: Li },
  Pi = {
    "clear-night": "ท้องฟ้าแจ่มใส",
    cloudy: "มีเมฆเป็นส่วนมาก",
    fog: "หมอก",
    hail: "ลูกเห็บ",
    lightning: "พายุฝนฟ้าคะนอง",
    "lightning-rainy": "ฝนฟ้าคะนอง",
    partlycloudy: "มีเมฆบางส่วน",
    pouring: "ฝนตกหนัก",
    rainy: "ฝนตก",
    snowy: "หิมะตก",
    "snowy-rainy": "ฝนตกเป็นลูกเห็บ",
    sunny: "แดดจัด",
    windy: "มีลมจัด",
    "windy-variant": "ลมแรง",
    exceptional: "Exceptional",
  },
  Hi = { 1: "จ.", 2: "อ.", 3: "พ.", 4: "พฤ.", 5: "ศ.", 6: "ส.", 7: "อา." },
  Wi = { aqi: "AQI", humidity: "ความชื้น", "feels-like": "Feels like" },
  qi = { weather: Pi, day: Hi, misc: Wi },
  Ri = {
    "clear-night": "Açık",
    cloudy: "Bulutlu",
    fog: "Sis",
    hail: "Dolu",
    lightning: "Gökgürültülü",
    "lightning-rainy": "Gökgürültülü Yağmurlu",
    partlycloudy: "Parçalı Bulutlu",
    pouring: "Sağanak",
    rainy: "Yağmurlu",
    snowy: "Karlı",
    "snowy-rainy": "Sulu Kar",
    sunny: "Güneşli",
    windy: "Rüzgarlı",
    "windy-variant": "Güçlü Rüzgar",
    exceptional: "Mükemmel",
  },
  Yi = { 1: "Pzt", 2: "Sal", 3: "Çrş", 4: "Prş", 5: "Cum", 6: "Cts", 7: "Pzr" },
  Ji = { aqi: "AQI", humidity: "nem", "feels-like": "Feels like" },
  Qi = { weather: Ri, day: Yi, misc: Ji },
  Ki = {
    "clear-night": "Ясно",
    cloudy: "Хмарно",
    fog: "Туман",
  ...
  Xi = { 1: "Пн", 2: "Вт", 3: "Ср", 4: "Чт", 5: "Пт", 6: "Сб", 7: "Нд" },
  er = { aqi: "AQI", humidity: "вологість", "feels-like": "Feels like" },
  tr = { weather: Ki, day: Xi, misc: er },
  ir = {
    "clear-night": "صاف",
    cloudy: "ابر آلود",
    fog: "دھند",
  ...
  sr = { aqi: "AQI", humidity: "نمی", "feels-like": "Feels like" },
  ar = { weather: ir, day: rr, misc: sr },
  nr = {
    "clear-night": "Trời trong",
    cloudy: "Trời mây",
    fog: "Sương mù",
    hail: "Mưa đá",
    lightning: "Dông bão",
    "lightning-rainy": "Mưa Dông",
    partlycloudy: "Mây nhẹ",
    pouring: "Mưa Lớn",
    rainy: "Mưa",
    snowy: "Tuyết",
  ...
  or = { 1: "T2", 2: "T3", 3: "T4", 4: "T5", 5: "T6", 6: "T7", 7: "CN" },
  lr = { aqi: "AQI", humidity: "độ ẩm", "feels-like": "Feels like" },
  cr = { weather: nr, day: or, misc: lr },
  dr = {
    "clear-night": "夜间晴朗",
    cloudy: "阴",
    fog: "雾",
  ...
  hr = { aqi: "AQI", humidity: "湿度", "feels-like": "Feels like" },
  mr = { weather: dr, day: ur, misc: hr },
  fr = {
    "clear-night": "晴朗夜晚",
    cloudy: "多雲",
    fog: "有霧",
  ...
  yr = { aqi: "空氣品質", humidity: "濕度", "feels-like": "體感溫度" },
  br = { weather: fr, day: pr, misc: yr };
const gr = {
  bg: Ae,
  cs: Object.freeze({
    __proto__: null,
...
const Gr = {
  ...
  Er = {
    line: {
      ...
      cloudy:
        "data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 512 512'%3e%3cdefs%3e%3csymbol id='a' viewBox='0 0 359 231'%3e%3cpath fill='none' stroke='%23e2e8f0' stroke-linecap='round' stroke-linejoin='round' stroke-width='15' d='M295.5 223.5a56 56 0 000-112l-2.5.1a83.9 83.9 0 00-153-64.2 56 56 0 00-84.6 48.1 56.6 56.6 0 00.8 9 60 60 0 0011.2 119'/%3e%3c/symbol%3e%3c/defs%3e%3cuse xlink:href='%23a' width='359' height='231' transform='translate(76.5 140.5)'/%3e%3c/svg%3e",
      "clear-night": { day: Br, night: Zr },
      fog: {
        day: "data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 512 512'%3e%3cdefs%3e%3csymbol id='b' viewBox='0 0 375 375'%3e%3ccircle cx='187.5' cy='187.5' r='84' fill='none' stroke='%23fbbf24' stroke-miterlimit='10' stroke-width='15'/%3e%3cpath fill='none' stroke='%23fbbf24' stroke-linecap='round' stroke-miterlimit='10' stroke-width='15' d='M187.5 57.2V7.5m0 360v-49.7m92.2-222.5 35-35M60.3 314.7l35.1-35.1m0-184.4-35-35m254.5 254.5-35.1-35.1M57.2 187.5H7.5m360 0h-49.7'/%3e%3c/symbol%3e%3csymbol id='c' viewBox='0 0 258 66'%3e%3cpath fill='none' stroke='%23e2e8f0' stroke-linecap='round' stroke-miterlimit='10' stroke-width='18' d='M9 57h240M9 9h240'/%3e%3c/symbol%3e%3cclipPath id='a'%3e%3cpath fill='none' d='M0 0h512v306H0z'/%3e%3c/clipPath%3e%3c/defs%3e%3cg clip-path='url(%23a)'%3e%3cuse xlink:href='%23b' width='375' height='375' transform='translate(68.5 104.5)'/%3e%3c/g%3e%3cuse xlink:href='%23c' width='258' height='66' transform='translate(127 339)'/%3e%3c/svg%3e",
        night:
          "data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 512 512'%3e%3cdefs%3e%3csymbol id='b' viewBox='0 0 279 279'%3e%3cpath fill='none' stroke='%2372b9d5' stroke-linecap='round' stroke-linejoin='round' stroke-width='15' d='M256.8 173.1A133.3 133.3 0 01122.4 40.7 130.5 130.5 0 01127 7.5 133 133 0 007.5 139.1c0 73.1 60 132.4 134.2 132.4 62.5 0 114.8-42.2 129.8-99.2a135.6 135.6 0 01-14.8.8Z'/%3e%3c/symbol%3e%3csymbol id='c' viewBox='0 0 258 66'%3e%3cpath fill='none' stroke='%23e2e8f0' stroke-linecap='round' stroke-miterlimit='10' stroke-width='18' d='M9 57h240M9 9h240'/%3e%3c/symbol%3e%3cclipPath id='a'%3e%3cpath fill='none' d='M0 0h512v306H0z'/%3e%3c/clipPath%3e%3c/defs%3e%3cg clip-path='url(%23a)'%3e%3cuse xlink:href='%23b' width='279' height='279' transform='translate(116.5 116.5)'/%3e%3c/g%3e%3cuse xlink:href='%23c' width='258' height='66' transform='translate(127 339)'/%3e%3c/svg%3e",
      },
      hail: "data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 512 512'%3e%3cdefs%3e%3csymbol id='a' viewBox='0 0 359 231'%3e%3cpath fill='none' stroke='%23e2e8f0' stroke-linecap='round' stroke-linejoin='round' stroke-width='15' d='M295.5 223.5a56 56 0 000-112l-2.5.1a83.9 83.9 0 00-153-64.2 56 56 0 00-84.6 48.1 56.6 56.6 0 00.8 9 60 60 0 0011.2 119'/%3e%3c/symbol%3e%3csymbol id='b' viewBox='0 0 136 114'%3e%3cpath fill='%2386c3db' d='M12 0a12 12 0 1012 12A12 12 0 0012 0Zm56 90a12 12 0 1012 12 12 12 0 00-12-12Zm56-60a12 12 0 1012 12 12 12 0 00-12-12Z'/%3e%3c/symbol%3e%3c/defs%3e%3cuse xlink:href='%23a' width='359' height='231' transform='translate(76.5 140.5)'/%3e%3cuse xlink:href='%23b' width='136' height='114' transform='translate(188 350)'/%3e%3c/svg%3e",
      lightning: {
    ...
    fill: {
      ...
      cloudy:
        "data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 512 512'%3e%3cdefs%3e%3clinearGradient id='a' x1='99.5' x2='232.6' y1='30.7' y2='261.4' gradientUnits='userSpaceOnUse'%3e%3cstop offset='0' stop-color='%23f3f7fe'/%3e%3cstop offset='.5' stop-color='%23f3f7fe'/%3e%3cstop offset='1' stop-color='%23deeafb'/%3e%3c/linearGradient%3e%3csymbol id='b' viewBox='0 0 350 222'%3e%3cpath fill='url(%23a)' stroke='%23e6effc' stroke-miterlimit='10' stroke-width='6' d='m291 107-2.5.1A83.9 83.9 0 00135.6 43 56 56 0 0051 91a56.6 56.6 0 00.8 9A60 60 0 0063 219l4-.2v.2h224a56 56 0 000-112Z'/%3e%3c/symbol%3e%3c/defs%3e%3cuse xlink:href='%23b' width='350' height='222' transform='translate(81 145)'/%3e%3c/svg%3e",
      "clear-night": { day: Cr, night: $r },
      fog: {
      ...
      sunny: { day: Cr, night: $r },
      windy: Ur,
      "windy-exceptional": Ur,
      exceptional:
        "data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'%3e%3cdefs%3e%3clinearGradient id='a' x1='175.8' x2='336.2' y1='117' y2='395' gradientUnits='userSpaceOnUse'%3e%3cstop offset='0' stop-color='%23d4d7dd'/%3e%3cstop offset='.5' stop-color='%23d4d7dd'/%3e%3cstop offset='1' stop-color='%23bec1c6'/%3e%3c/linearGradient%3e%3c/defs%3e%3cpath fill='none' stroke='url(%23a)' stroke-linecap='round' stroke-miterlimit='10' stroke-width='24' d='M344 256a88 88 0 11-88-88 88 88 0 0188 88ZM200 116.9l-3.8 7.7A269.7 269.7 0 00169 267h0m143.1 128 3.8-7.7A269.7 269.7 0 00343.2 245h0'/%3e%3c/svg%3e",
    },
  };
function Dr(e) {
  try {
    ...
    return (
      console.error(
        "clock-weather-card - Error while rendering clock-weather-card component:",
        e,
      ),
      D``
    );
...
const qr = "numeric",
  Rr = "short",
  Yr = "long",
  Jr = { year: qr, month: qr, day: qr },
  Qr = { year: qr, month: Rr, day: qr },
  Kr = { year: qr, month: Rr, day: qr, weekday: Rr },
  Xr = { year: qr, month: Yr, day: qr },
  es = { year: qr, month: Yr, day: qr, weekday: Yr },
  ts = { hour: qr, minute: qr },
  is = { hour: qr, minute: qr, second: qr },
  rs = { hour: qr, minute: qr, second: qr, timeZoneName: Rr },
  ss = { hour: qr, minute: qr, second: qr, timeZoneName: Yr },
  as = { hour: qr, minute: qr, hourCycle: "h23" },
  ns = { hour: qr, minute: qr, second: qr, hourCycle: "h23" },
  os = { hour: qr, minute: qr, second: qr, hourCycle: "h23", timeZoneName: Rr },
  ls = { hour: qr, minute: qr, second: qr, hourCycle: "h23", timeZoneName: Yr },
  cs = { year: qr, month: qr, day: qr, hour: qr, minute: qr },
  ds = { year: qr, month: qr, day: qr, hour: qr, minute: qr, second: qr },
  us = { year: qr, month: Rr, day: qr, hour: qr, minute: qr },
  hs = { year: qr, month: Rr, day: qr, hour: qr, minute: qr, second: qr },
  ms = { year: qr, month: Rr, day: qr, weekday: Rr, hour: qr, minute: qr },
  fs = { year: qr, month: Yr, day: qr, hour: qr, minute: qr, timeZoneName: Rr },
  ps = {
    year: qr,
    month: Yr,
    day: qr,
...
let ks = {};
const xs = { year: 0, month: 1, day: 2, era: 3, hour: 4, minute: 5, second: 6 };
let Ts = {};
class Ms extends gs {
  static create(e) {
    return Ts[e] || (Ts[e] = new Ms(e)), Ts[e];
  }
  static resetCache() {
    (Ts = {}), (ks = {});
  }
  ...
  constructor(e) {
    super(), (this.zoneName = e), (this.valid = Ms.isValidZone(e));
  }
  get type() {
    return "iana";
  }
  ...
  offset(e) {
    ...
    const i =
      ((r = this.name),
      ks[r] ||
        (ks[r] = new Intl.DateTimeFormat("en-US", {
          hour12: !1,
          timeZone: r,
          year: "numeric",
          month: "2-digit",
      ...
      ks[r]);
    var r;
    let [s, a, n, o, l, c, d] = i.formatToParts
      ? (function (e, t) {
          ...
          for (let e = 0; e < i.length; e++) {
            const { type: t, value: s } = i[e],
              a = xs[t];
            "era" === t ? (r[a] = s) : ba(a) || (r[a] = parseInt(s, 10));
          }
          return r;
        })(i, t)
      : (function (e, t) {
          const i = e.format(t).replace(/\u200E/g, ""),
            r = /(\d+)\/(\d+)\/(\d+) (AD|BC),? (\d+):(\d+):(\d+)/.exec(i),
            [, s, a, n, o, l, c, d] = r;
          return [n, s, a, o, l, c, d];
        })(i, t);
    "BC" === o && (s = 1 - Math.abs(s));
    let u = +t;
    const h = u % 1e3;
...
function Ns(e, t = {}) {
  ...
  let r = _s[i];
  return r || ((r = new Intl.DateTimeFormat(e, t)), (_s[i] = r)), r;
}
let Os = {};
let As = {};
let $s = null;
    ...
    if (!t || Object.keys(a).length > 0) {
      ...
      i.padTo > 0 && (t.minimumIntegerDigits = i.padTo),
        (this.inf = (function (e, t = {}) {
          const i = JSON.stringify([e, t]);
          let r = Os[i];
          return r || ((r = new Intl.NumberFormat(e, t)), (Os[i] = r)), r;
        })(e, t));
    }
  }
  format(e) {
    ...
    return _a(this.floor ? Math.floor(e) : $a(e, 3), this.padTo);
  }
}
class Us {
  constructor(e, t, i) {
    ...
    if (((this.opts = i), (this.originalZone = void 0), this.opts.timeZone))
      ...
      "system" === e.zone.type
        ...
        : ((r = "UTC"),
          ...
          (this.originalZone = e.zone));
    const s = { ...this.opts };
    (s.timeZone = s.timeZone || r), (this.dtf = Ns(t, s));
  }
  format() {
    ...
    (this.opts = { style: "long", ...i }),
      !t &&
        ...
        (this.rtf = (function (e, t = {}) {
          ...
          let a = As[s];
          return a || ((a = new Intl.RelativeTimeFormat(e, t)), (As[s] = a)), a;
        })(e, i));
  }
  format(e, t) {
    return this.rtf
      ? this.rtf.format(e, t)
      : (function (e, t, i = "always", r = !1) {
          const s = {
              years: ["year", "yr."],
          ...
          const n = Object.is(t, -0) || t < 0,
            o = Math.abs(t),
            l = 1 === o,
            c = s[e],
            d = r ? (l ? c[1] : c[2] || c[1]) : l ? s[e][0] : e;
          return n ? `${o} ${d} ago` : `in ${o} ${d}`;
...
const Gs = { firstDay: 1, minimalDays: 4, weekend: [6, 7] };
class Es {
  static fromOpts(e) {
    return Es.create(
      e.locale,
  ...
  static create(e, t, i, r, s = !1) {
    const a = e || ta.defaultLocale,
      n =
        a ||
        (s
          ? "en-US"
          : $s ||
            (($s = new Intl.DateTimeFormat().resolvedOptions().locale), $s)),
      o = t || ta.defaultNumberingSystem,
      l = i || ta.defaultOutputCalendar,
      c = Ma(r) || ta.defaultWeekSettings;
    return new Es(n, o, l, c, a);
  }
  static resetCache() {
    ($s = null), (_s = {}), (Os = {}), (As = {});
  }
  static fromObject({
    ...
    return Es.create(e, t, i, r);
  }
  constructor(e, t, i, r, s) {
    const [a, n, o] = (function (e) {
      const t = e.indexOf("-x-");
      ...
      if (-1 === i) return [e];
      {
        let t, r;
        try {
          (t = Ns(e).resolvedOptions()), (r = e);
        } catch (s) {
          const a = e.substring(0, i);
          (t = Ns(a).resolvedOptions()), (r = a);
        }
        const { numberingSystem: s, calendar: a } = t;
        return [r, s, a];
      }
    })(e);
    (this.locale = a),
      (this.numberingSystem = t || n || null),
  ...
  eras(e) {
    return Cs(this, e, rn, () => {
      ...
      return (
        this.eraCache[e] ||
          (this.eraCache[e] = [Ko.utc(-40, 1, 1), Ko.utc(2017, 1, 1)].map((e) =>
  ...
  dtFormatter(e, t = {}) {
    return new Us(e, this.intl, t);
  }
  relFormatter(e = {}) {
    return new Vs(this.intl, this.isEnglish(), e);
  }
  listFormatter(e = {}) {
    return (function (e, t = {}) {
      const i = JSON.stringify([e, t]);
      let r = Ss[i];
      return r || ((r = new Intl.ListFormat(e, t)), (Ss[i] = r)), r;
    })(this.intl, e);
  }
  isEnglish() {
    return (
    ...
    return this.weekSettings
      ...
      ? (function (e) {
          ...
          if (!t) {
            ...
            (t = "getWeekInfo" in i ? i.getWeekInfo() : i.weekInfo),
              (Zs[e] = t);
          }
          return t;
        })(this.locale)
...
class js extends gs {
  static get utcInstance() {
    return null === Ds && (Ds = new js(0)), Ds;
  }
  static instance(e) {
    return 0 === e ? js.utcInstance : new js(e);
  }
  static parseSpecifier(e) {
    if (e) {
      const t = e.match(/^utc(?:([+-]\d{1,2})(?::(\d{2}))?)?$/i);
      if (t) return new js(ja(t[1], t[2]));
    }
    return null;
  }
  constructor(e) {
  ...
  get name() {
    return 0 === this.fixed ? "UTC" : `UTC${La(this.fixed, "narrow")}`;
  }
  get ianaName() {
    return 0 === this.fixed ? "Etc/UTC" : `Etc/GMT${La(-this.fixed, "narrow")}`;
  }
  offsetName() {
    return this.name;
  }
  formatOffset(e, t) {
    return La(this.fixed, t);
  }
  get isUniversal() {
    return !0;
  }
...
function zs(e, t) {
  ...
  if (
    ...
    return "default" === i
      ...
      : "utc" === i || "gmt" === i
      ? js.utcInstance
      : js.parseSpecifier(i) || Ms.create(e);
  }
  return ga(e)
    ? js.instance(e)
...
const Ls = {
  ...
  Ps = Ls.hanidec.replace(/[\[|\]]/g, "").split("");
let Hs = {};
function Ws({ numberingSystem: e }, t = "") {
  const i = e || "latn";
  return (
    Hs[i] || (Hs[i] = {}),
    Hs[i][t] || (Hs[i][t] = new RegExp(`${Ls[i]}${t}`)),
    Hs[i][t]
  );
}
let qs,
...
class ta {
  ...
  static resetCaches() {
    Es.resetCache(), Ms.resetCache(), Ko.resetCache(), (Hs = {});
  }
}
class ia {
  constructor(e, t) {
...
function na(e, t, i) {
  const r = new Date(Date.UTC(e, t - 1, i));
  e < 100 && e >= 0 && r.setUTCFullYear(r.getUTCFullYear() - 1900);
  const s = r.getUTCDay();
  return 0 === s ? 7 : s;
}
function oa(e, t, i) {
  return i + (Za(e) ? sa : ra)[t - 1];
}
function la(e, t) {
  const i = Za(e) ? sa : ra,
    r = i.findIndex((e) => e < t);
  return { month: r + 1, day: t - i[r] };
}
function ca(e, t) {
  return ((e - t + 7) % 7) + 1;
}
function da(e, t = 4, i = 1) {
  const { year: r, month: s, day: a } = e,
    n = oa(r, s, a),
    o = ca(na(r, s, a), i);
  let l,
    c = Math.floor((n - o + 14 - t) / 7);
  return (
    c < 1
      ? ((l = r - 1), (c = Ga(l, t, i)))
      : c > Ga(r, t, i)
      ? ((l = r + 1), (c = 1))
      : (l = r),
    { weekYear: l, weekNumber: c, weekday: o, ...Fa(e) }
  );
}
function ua(e, t = 4, i = 1) {
  const { weekYear: r, weekNumber: s, weekday: a } = e,
    n = ca(na(r, 1, t), i),
    o = Ca(r);
  let l,
    c = 7 * s + a - n - 7 + t;
  c < 1
    ...
    ? ((l = r + 1), (c -= Ca(r)))
    : (l = r);
  const { month: d, day: u } = la(l, c);
  return { year: l, month: d, day: u, ...Fa(e) };
}
function ha(e) {
  const { year: t, month: i, day: r } = e;
  return { year: t, ordinal: oa(t, i, r), ...Fa(e) };
}
function ma(e) {
  const { year: t, ordinal: i } = e,
    { month: r, day: s } = la(t, i);
  return { year: t, month: r, day: s, ...Fa(e) };
}
function fa(e, t) {
  if (!ba(e.localWeekday) || !ba(e.localWeekNumber) || !ba(e.localWeekYear)) {
    if (!ba(e.weekday) || !ba(e.weekNumber) || !ba(e.weekYear))
      throw new Fr(
        "Cannot mix locale-based week fields with ISO-based week fields",
      );
    return (
      ba(e.localWeekday) || (e.weekday = e.localWeekday),
      ba(e.localWeekNumber) || (e.weekNumber = e.localWeekNumber),
      ba(e.localWeekYear) || (e.weekYear = e.localWeekYear),
...
function pa(e) {
  const t = wa(e.year),
    i = Sa(e.month, 1, 12),
    r = Sa(e.day, 1, Ba(e.year, e.month));
  return t
    ? i
      ? !r && aa("day", e.day)
      : aa("month", e.month)
...
function ya(e) {
  const { hour: t, minute: i, second: r, millisecond: s } = e,
    a = Sa(t, 0, 23) || (24 === t && 0 === i && 0 === r && 0 === s),
    n = Sa(i, 0, 59),
    o = Sa(r, 0, 59),
    l = Sa(s, 0, 999);
  return a
...
function Ma(e) {
  ...
  if ("object" != typeof e) throw new Hr("Week settings must be an object");
  if (
    !Sa(e.firstDay, 1, 7) ||
    !Sa(e.minimalDays, 1, 7) ||
    !Array.isArray(e.weekend) ||
    e.weekend.some((e) => !Sa(e, 1, 7))
  )
    throw new Hr("Invalid week settings");
  return {
    firstDay: e.firstDay,
...
function Na(e) {
  return ba(e) || null === e || "" === e ? void 0 : parseInt(e, 10);
}
function Oa(e) {
  return ba(e) || null === e || "" === e ? void 0 : parseFloat(e);
}
function Aa(e) {
  if (!ba(e) && null !== e && "" !== e) {
...
function $a(e, t, i = !1) {
  const r = 10 ** t;
  return (i ? Math.trunc : Math.round)(e * r) / r;
}
function Za(e) {
...
function Va(e, t, i) {
  return -ca(na(e, 1, t), i) + t - 1;
}
function Ga(e, t = 4, i = 1) {
  const r = Va(e, t, i),
    s = Va(e + 1, t, i);
  return (Ca(e) - r + s) / 7;
}
function Ea(e) {
  return e > 99 ? e : e > ta.twoDigitCutoffYear ? 1900 + e : 2e3 + e;
}
function Da(e, t, i, r = null) {
  const s = new Date(e),
    a = {
      hourCycle: "h23",
      year: "numeric",
  ...
  r && (a.timeZone = r);
  const n = { timeZoneName: t, ...a },
    o = new Intl.DateTimeFormat(i, n)
      .formatToParts(s)
...
function ja(e, t) {
  ...
  return 60 * i + (i < 0 || Object.is(i, -0) ? -r : r);
}
function Ia(e) {
  const t = Number(e);
...
const Ra = [
  ...
  Ya = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
  Ja = ["M", "T", "W", "T", "F", "S", "S"];
function Qa(e) {
  switch (e) {
    case "narrow":
...
function sn(e, t) {
  let i = "";
  for (const r of e) r.literal ? (i += r.val) : (i += t(r.val));
  return i;
}
const an = {
  D: Jr,
...
class nn {
  ...
  num(e, t = 0) {
    if (this.opts.forceSimple) return _a(e, t);
    const i = { ...this.opts };
    ...
    const i = "en" === this.loc.listingMode(),
      ...
      o = (t, r) =>
        i
          ...
          : s(r ? { month: t } : { month: t, day: "numeric" }, "month"),
      l = (t, r) =>
        i
          ? (function (e, t) {
              return Qa(t)[e.weekday - 1];
            })(e, t)
          : s(
              r
                ? { weekday: t }
      ...
      c = (t) => {
        const i = nn.macroTokenToFormatOpts(t);
        return i ? this.formatWithSystemDefault(e, i) : t;
      },
      d = (t) =>
        i
          ? (function (e, t) {
              return rn(t)[e.year < 0 ? 0 : 1];
            })(e, t)
          : s({ era: t }, "era");
    return sn(nn.parseFormat(t), (t) => {
      switch (t) {
        case "S":
  ...
  formatDurationFromString(e, t) {
    const i = (e) => {
      ...
      r = nn.parseFormat(t),
      s = r.reduce((e, { literal: t, val: i }) => (t ? e : e.concat(i)), []),
      a = e.shiftTo(...s.map(i).filter((e) => e));
    return sn(
      r,
      ((e) => (t) => {
        const r = i(t);
...
function un(...e) {
  return (t, i) => {
    const r = {};
    let s;
    for (s = 0; s < e.length; s++) r[e[s]] = Na(t[i + s]);
    return [r, null, i + s];
  };
}
const hn = /(?:(Z)|([+-]\d\d)(?::?(\d\d))?)/,
  mn = /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/,
  fn = RegExp(`${mn.source}${`(?:${hn.source}?(?:\\[(${on.source})\\])?)?`}`),
  pn = RegExp(`(?:T${fn.source})?`),
  yn = un("weekYear", "weekNumber", "weekDay"),
  bn = un("year", "ordinal"),
  gn = RegExp(`${mn.source} ?(?:${hn.source}|(${on.source}))?`),
  wn = RegExp(`(?: ${gn.source})?`);
function vn(e, t, i) {
  const r = e[t];
  return ba(r) ? i : Na(r);
...
function xn(e, t) {
  const i = !e[t] && !e[t + 1],
    r = ja(e[t + 1], e[t + 2]);
  return [{}, i ? null : js.instance(r), t + 3];
}
function Tn(e, t) {
  return [{}, e[t] ? Ms.create(e[t]) : null, t + 1];
}
const Mn = RegExp(`^T?${mn.source}$`),
  Sn =
    /^-?P(?:(?:(-?\d{1,20}(?:\.\d{1,20})?)Y)?(?:(-?\d{1,20}(?:\.\d{1,20})?)M)?(?:(-?\d{1,20}(?:\.\d{1,20})?)W)?(?:(-?\d{1,20}(?:\.\d{1,20})?)D)?(?:T(?:(-?\d{1,20}(?:\.\d{1,20})?)H)?(?:(-?\d{1,20}(?:\.\d{1,20})?)M)?(?:(-?\d{1,20})(?:[.,](-?\d{1,20}))?S)?)?)$/;
function _n(e) {
  const [t, i, r, s, a, n, o, l, c] = e,
    d = "-" === t[0],
    u = l && "-" === l[0],
...
function On(e, t, i, r, s, a, n) {
  const o = {
    year: 2 === t.length ? Ea(Na(t)) : Na(t),
    month: Ha.indexOf(i) + 1,
    day: Na(r),
    hour: Na(s),
    minute: Na(a),
  };
  return (
    n && (o.second = Na(n)),
    e && (o.weekday = e.length > 3 ? Ra.indexOf(e) + 1 : Ya.indexOf(e) + 1),
    o
  );
}
const An =
...
function $n(e) {
  const [, t, i, r, s, a, n, o, l, c, d, u] = e,
    h = On(t, s, r, i, a, n, o);
  let m;
  return (m = l ? Nn[l] : c ? 0 : ja(d, u)), [h, new js(m)];
}
const Zn =
...
function Un(e) {
  const [, t, i, r, s, a, n, o] = e;
  return [On(t, s, r, i, a, n, o), js.utcInstance];
}
function Vn(e) {
  const [, t, i, r, s, a, n, o] = e;
  return [On(t, o, i, r, s, a, n), js.utcInstance];
}
const Gn = ln(/([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/, pn),
  En = ln(/(\d{4})-?W(\d\d)(?:-?(\d))?/, pn),
  Dn = ln(/(\d{4})-?(\d{3})/, pn),
  jn = ln(fn),
  In = cn(
    function (e, t) {
      return [
        { year: vn(e, t), month: vn(e, t + 1, 1), day: vn(e, t + 2, 1) },
        null,
        t + 3,
      ];
    },
  ...
  Fn = cn(kn, xn, Tn);
const Pn = cn(kn);
const Hn = ln(/(\d{4})-(\d\d)-(\d\d)/, wn),
  Wn = ln(gn),
  qn = cn(kn, xn, Tn);
const Rn = "Invalid Duration",
  Yn = {
    weeks: {
      days: 7,
      hours: 168,
...
function ro(e, t) {
  ...
  for (const r of to.slice(1)) t[r] && (i += t[r] * e[r].milliseconds);
  return i;
}
function so(e, t) {
  const i = ro(e, t) < 0 ? -1 : 1;
  eo.reduceRight((r, s) => {
    if (ba(t[s])) return r;
    if (r) {
      const a = t[r] * i,
...
class ao {
  ...
  static fromMillis(e, t) {
    return ao.fromObject({ milliseconds: e }, t);
  }
  ...
  static fromDurationLike(e) {
    if (ga(e)) return ao.fromMillis(e);
    if (ao.isDuration(e)) return e;
    if ("object" == typeof e) return ao.fromObject(e);
    throw new Hr(`Unknown duration argument ${e} of type ${typeof e}`);
  }
  static fromISO(e, t) {
    const [i] = (function (e) {
      return dn(e, [Sn, _n]);
  ...
  static invalid(e, t = null) {
    if (!e) throw new Hr("need to specify a reason the Duration is invalid");
    const i = e instanceof ia ? e : new ia(e, t);
    if (ta.throwOnInvalid) throw new Lr(i);
    return new ao({ invalid: i });
  }
  ...
  toFormat(e, t = {}) {
    ...
    return this.isValid
      ? nn.create(this.loc, i).formatDurationFromString(this, e)
      : Rn;
  }
  toHuman(e = {}) {
  ...
  toISO() {
    ...
    return (
      ...
      (0 === this.seconds && 0 === this.milliseconds) ||
        (e += $a(this.seconds + this.milliseconds / 1e3, 3) + "S"),
      "P" === e && (e += "T0S"),
      e
    );
  }
  toISOTime(e = {}) {
    ...
    return Ko.fromMillis(t, { zone: "UTC" }).toISOTime(e);
  }
  toJSON() {
    return this.toISO();
  }
  ...
  plus(e) {
    ...
    const t = ao.fromDurationLike(e),
      i = {};
    for (const e of eo)
      (Ta(t.values, e) || Ta(this.values, e)) &&
        (i[e] = t.get(e) + this.get(e));
    return io(this, { values: i }, !0);
  }
  minus(e) {
    if (!this.isValid) return this;
    const t = ao.fromDurationLike(e);
  ...
  mapUnits(e) {
    if (!this.isValid) return this;
    const t = {};
    for (const i of Object.keys(this.values)) t[i] = Ia(e(this.values[i], i));
    return io(this, { values: t }, !0);
  }
  get(e) {
    return this[ao.normalizeUnit(e)];
  }
  set(e) {
    if (!this.isValid) return this;
    return io(this, { values: { ...this.values, ...za(e, ao.normalizeUnit) } });
  }
  reconfigure({
    locale: e,
    numberingSystem: t,
  ...
  normalize() {
    ...
    return so(this.matrix, e), io(this, { values: e }, !0);
  }
  rescale() {
    if (!this.isValid) return this;
    return io(
      this,
      {
        values: (function (e) {
          const t = {};
          for (const [i, r] of Object.entries(e)) 0 !== r && (t[i] = r);
          return t;
  ...
  shiftTo(...e) {
    ...
    for (const a of eo)
      if (e.indexOf(a) >= 0) {
        s = a;
        let e = 0;
        for (const t in i) (e += this.matrix[t][a] * i[t]), (i[t] = 0);
        ga(r[a]) && (e += r[a]);
        const n = Math.trunc(e);
        (t[a] = n), (i[a] = (1e3 * e - 1e3 * n) / 1e3);
      } else ga(r[a]) && (i[a] = r[a]);
    for (const e in i)
      0 !== i[e] && (t[s] += e === s ? i[e] : i[e] / this.matrix[s][e]);
    return so(this.matrix, t), io(this, { values: t }, !0);
  }
  shiftToAll() {
    return this.isValid
      ? this.shiftTo(
...
class oo {
  ...
  static invalid(e, t = null) {
    if (!e) throw new Hr("need to specify a reason the Interval is invalid");
    const i = e instanceof ia ? e : new ia(e, t);
    if (ta.throwOnInvalid) throw new zr(i);
    return new oo({ invalid: i });
  }
        ...
        return e && e.isValid
          ? t && t.isValid
            ? t < e
              ...
              : null
            : oo.invalid("missing or invalid end")
          : oo.invalid("missing or invalid start");
      })(i, r);
    return null == s ? new oo({ start: i, end: r }) : s;
  }
  static after(e, t) {
    const i = ao.fromDurationLike(t),
      r = Xo(e);
    return oo.fromDateTimes(r, r.plus(i));
  }
  static before(e, t) {
    const i = ao.fromDurationLike(t),
      r = Xo(e);
    return oo.fromDateTimes(r.minus(i), r);
  }
  static fromISO(e, t) {
    const [i, r] = (e || "").split("/", 2);
    if (i && r) {
      let e, s, a, n;
      try {
        (e = Ko.fromISO(i, t)), (s = e.isValid);
      } catch (r) {
        s = !1;
      }
      try {
        (a = Ko.fromISO(r, t)), (n = a.isValid);
      } catch (r) {
        n = !1;
      }
      if (s && n) return oo.fromDateTimes(e, a);
      if (s) {
        const i = ao.fromISO(r, t);
        if (i.isValid) return oo.after(e, i);
      } else if (n) {
        const e = ao.fromISO(i, t);
        if (e.isValid) return oo.before(a, e);
      }
    }
    return oo.invalid(
      "unparsable",
  ...
  count(e = "milliseconds", t) {
    ...
    return (
      (r = t?.useLocaleWeeks
        ? this.end.reconfigure({ locale: i.locale })
        : this.end),
      (r = r.startOf(e, t)),
  ...
  set({ start: e, end: t } = {}) {
    return this.isValid ? oo.fromDateTimes(e || this.s, t || this.e) : this;
  }
  splitAt(...e) {
    ...
    for (; r < this.e; ) {
      const e = t[s] || this.e,
        a = +e > +this.e ? this.e : e;
      i.push(oo.fromDateTimes(r, a)), (r = a), (s += 1);
    }
    return i;
  }
  splitBy(e) {
  ...
  intersection(e) {
    ...
    return t >= i ? null : oo.fromDateTimes(t, i);
  }
  union(e) {
    if (!this.isValid) return this;
    const t = this.s < e.s ? this.s : e.s,
      i = this.e > e.e ? this.e : e.e;
    return oo.fromDateTimes(t, i);
  }
  static merge(e) {
    const [t, i] = e
      .sort((e, t) => e.s - t.s)
  ...
  static xor(e) {
    ...
    const r = [],
      ...
      a = Array.prototype.concat(...s).sort((e, t) => e.time - t.time);
    for (const e of a)
      (i += "s" === e.type ? 1 : -1),
        1 === i
          ? (t = e.time)
          : (t && +t != +e.time && r.push(oo.fromDateTimes(t, e.time)),
            (t = null));
    return oo.merge(r);
  }
  difference(...e) {
  ...
  toString() {
    return this.isValid ? `[${this.s.toISO()} – ${this.e.toISO()})` : no;
  }
  [Symbol.for("nodejs.util.inspect.custom")]() {
    return this.isValid
  ...
  toLocaleString(e = Jr, t = {}) {
    return this.isValid
      ? nn.create(this.s.loc.clone(t), e).formatInterval(this)
      : no;
  }
  toISO(e) {
    return this.isValid ? `${this.s.toISO(e)}/${this.e.toISO(e)}` : no;
  }
  toISODate() {
    return this.isValid ? `${this.s.toISODate()}/${this.e.toISODate()}` : no;
  }
  toISOTime(e) {
    return this.isValid ? `${this.s.toISOTime(e)}/${this.e.toISOTime(e)}` : no;
  }
  toFormat(e, { separator: t = " – " } = {}) {
    return this.isValid ? `${this.s.toFormat(e)}${t}${this.e.toFormat(e)}` : no;
  }
  toDuration(e, t) {
    return this.isValid
      ? this.e.diff(this.s, e, t)
      : ao.invalid(this.invalidReason);
  }
  mapEndpoints(e) {
    return oo.fromDateTimes(e(this.s), e(this.e));
  }
}
class lo {
  static hasDST(e = ta.defaultZone) {
    const t = Ko.now().setZone(e).set({ month: 12 });
    return !e.isUniversal && t.offset !== t.set({ month: 6 }).offset;
  }
  static isValidIANAZone(e) {
    return Ms.isValidZone(e);
  }
  static normalizeZone(e) {
    return zs(e, ta.defaultZone);
  }
  static getStartOfWeek({ locale: e = null, locObj: t = null } = {}) {
    return (t || Es.create(e)).getStartOfWeek();
  }
  static getMinimumDaysInFirstWeek({
    locale: e = null,
    locObj: t = null,
  } = {}) {
    return (t || Es.create(e)).getMinDaysInFirstWeek();
  }
  static getWeekendWeekdays({ locale: e = null, locObj: t = null } = {}) {
    return (t || Es.create(e)).getWeekendDays().slice();
  }
  static months(
    e = "long",
    {
    ...
    return (r || Es.create(t, i, s)).months(e);
  }
  static monthsFormat(
    e = "long",
    {
    ...
    return (r || Es.create(t, i, s)).months(e, !0);
  }
  static weekdays(
    e = "long",
    { locale: t = null, numberingSystem: i = null, locObj: r = null } = {},
  ) {
    return (r || Es.create(t, i, null)).weekdays(e);
  }
  static weekdaysFormat(
    e = "long",
    { locale: t = null, numberingSystem: i = null, locObj: r = null } = {},
  ) {
    return (r || Es.create(t, i, null)).weekdays(e, !0);
  }
  static meridiems({ locale: e = null } = {}) {
    return Es.create(e).meridiems();
  }
  static eras(e = "short", { locale: t = null } = {}) {
    return Es.create(t, null, "gregory").eras(e);
  }
  static features() {
    return { relative: va(), localeWeek: ka() };
  }
}
function co(e, t) {
  const i = (e) => e.toUTC(0, { keepLocalTime: !0 }).startOf("day").valueOf(),
    r = i(t) - i(e);
  return Math.floor(ao.fromMillis(r).as("days"));
}
function uo(e, t, i, r) {
  let [s, a, n, o] = (function (e, t, i) {
    const r = [
    ...
    for (const [l, c] of r)
      i.indexOf(l) >= 0 &&
        ...
        (o = a.plus(s)),
        o > t
          ? (s[l]--, (e = a.plus(s)) > t && ((o = e), s[l]--, (e = a.plus(s))))
          : (e = o));
    return [e, s, o, n];
  })(e, t, i);
  const l = t - s,
        ...
        (function (e) {
          ...
          if (isNaN(t)) {
            ...
            for (let i = 0; i < e.length; i++) {
              ...
              if (-1 !== e[i].search(Ls.hanidec)) t += Ps.indexOf(e[i]);
              else
                for (const e in Fs) {
                  const [i, s] = Fs[e];
                  r >= i && r <= s && (t += r - i);
...
const mo = `[ ${String.fromCharCode(160)}]`,
  fo = new RegExp(mo, "g");
function po(e) {
  return e.replace(/\./g, "\\.?").replace(fo, mo);
}
function yo(e) {
...
function bo(e, t) {
  return null === e
    ? null
    : {
        regex: RegExp(e.map(po).join("|")),
        deser: ([i]) => e.findIndex((e) => yo(i) === yo(e)) + t,
      };
}
function go(e, t) {
  return { regex: e, deser: ([, e, t]) => ja(e, t), groups: t };
}
function wo(e) {
  ...
  return Array.prototype.concat(
    ...e.map((e) =>
      (function (e, t) {
        ...
        const i = So(nn.macroTokenToFormatOpts(e.val), t);
...
class To {
  constructor(e, t) {
    if (
      ((this.locale = e),
      (this.format = t),
      (this.tokens = xo(nn.parseFormat(t), e)),
        ...
        (function (e, t) {
          const i = Ws(t),
            ...
            f = ((f) => {
              ...
              switch (f.val) {
                case "G":
                  return bo(t.eras("short"), 0);
                case "GG":
                  return bo(t.eras("long"), 0);
                case "y":
                  return ho(c);
                case "yy":
                case "kk":
                ...
                case "WW":
                  return ho(r);
                case "MMM":
                  return bo(t.months("short", !0), 1);
                case "MMMM":
                  return bo(t.months("long", !0), 1);
                case "LLL":
                  return bo(t.months("short", !1), 1);
                case "LLLL":
                  return bo(t.months("long", !1), 1);
                case "o":
                case "S":
                  return ho(l);
                case "ooo":
                ...
                case "c":
                  return ho(i);
                case "a":
                  return bo(t.meridiems(), 0);
                case "EEE":
                  return bo(t.weekdays("short", !1), 1);
                case "EEEE":
                  return bo(t.weekdays("long", !1), 1);
                case "ccc":
                  return bo(t.weekdays("short", !0), 1);
                case "cccc":
                  return bo(t.weekdays("long", !0), 1);
                case "Z":
                case "ZZ":
                  return go(
                ...
                case "ZZZ":
                  return go(new RegExp(`([+-]${o.source})(${r.source})?`), 2);
                case "z":
                  return wo(/[a-z_+-/]{1,256}?/i);
                case " ":
                  return wo(/[^\S\n\r]/);
                default:
                  return m(f);
      ...
      const [t, i] = (function (e, t, i) {
          ...
          if (r) {
            ...
            for (const s in i)
              if (Ta(i, s)) {
                const a = i[s],
                  n = a.groups ? a.groups + 1 : 1;
                !a.literal &&
                  a.token &&
                  (e[a.token.val[0]] = a.deser(r.slice(t, t + n))),
                  (t += n);
              }
            return [r, e];
          }
        ...
        [r, s, a] = i
          ? (function (e) {
              let t,
                i = null;
              ba(e.z) || (i = Ms.create(e.z)),
                ba(e.Z) || (i || (i = new js(e.Z)), (t = e.Z)),
                ba(e.q) || (e.M = 3 * (e.q - 1) + 1),
                ba(e.h) ||
                  (e.h < 12 && 1 === e.a
                    ? (e.h += 12)
                    : 12 === e.h && 0 === e.a && (e.h = 0)),
                0 === e.G && e.y && (e.y = -e.y),
                ba(e.u) || (e.S = Aa(e.u));
              const r = Object.keys(e).reduce((t, i) => {
                const r = ((e) => {
                  switch (e) {
                    case "S":
                      return "millisecond";
          ...
          : [null, null, void 0];
      if (Ta(i, "a") && Ta(i, "H"))
        throw new Fr("Can't include meridiem when specifying 24-hour format");
      return {
        input: e,
        tokens: this.tokens,
        regex: this.regex,
...
function Mo(e, t, i) {
  return new To(e, i).explainFromTokens(t);
}
function So(e, t) {
  if (!e) return null;
  const i = nn
      .create(t, e)
      .dtFormatter((ko || (ko = Ko.fromMillis(1555555555555)), ko)),
    r = i.formatToParts(),
    s = i.resolvedOptions();
  return r.map((t) =>
    (function (e, t, i) {
...
const _o = "Invalid DateTime",
  No = 864e13;
function Oo(e) {
  return new ia("unsupported zone", `the zone "${e.name}" is not supported`);
}
function Ao(e) {
...
function Co(e, t, i) {
  ...
  r -= 60 * (s - t) * 1e3;
  const a = i.offset(r);
  return s === a ? [r, s] : [e - 60 * Math.min(s, a) * 1e3, Math.max(s, a)];
}
function Bo(e, t) {
...
function Vo(e, t) {
  const i = e.o,
    ...
    n = ao
      ...
      .as("milliseconds"),
    o = Ua(a);
  let [l, c] = Co(o, i, e.zone);
  return 0 !== n && ((l += n), (c = e.zone.offset(l))), { ts: l, o: c };
}
function Go(e, t, i, r, s, a) {
  const { setZone: n, zone: o } = i;
  if ((e && 0 !== Object.keys(e).length) || t) {
    const r = t || o,
      s = Ko.fromObject(e, { ...i, zone: r, specificOffset: a });
    return n ? s : s.setZone(o);
  }
  return Ko.invalid(
    new ia("unparsable", `the input "${s}" can't be parsed as ${r}`),
  );
}
function Eo(e, t, i = !0) {
  return e.isValid
    ? nn
        .create(Es.create("en-US"), { allowZ: i, forceSimple: !0 })
        .formatDateTimeFromString(e, t)
    : null;
}
function Do(e, t) {
  ...
  return (
    ...
    (r += _a(e.c.year, i ? 6 : 4)),
    t
      ? ((r += "-"), (r += _a(e.c.month)), (r += "-"), (r += _a(e.c.day)))
      : ((r += _a(e.c.month)), (r += _a(e.c.day))),
    r
  );
}
function jo(e, t, i, r, s, a) {
  let n = _a(e.c.hour);
  return (
    t
      ? ((n += ":"),
        (n += _a(e.c.minute)),
        (0 === e.c.millisecond && 0 === e.c.second && i) || (n += ":"))
      : (n += _a(e.c.minute)),
    (0 === e.c.millisecond && 0 === e.c.second && i) ||
      ((n += _a(e.c.second)),
      (0 === e.c.millisecond && r) ||
        ((n += "."), (n += _a(e.c.millisecond, 3)))),
    s &&
      (e.isOffsetFixed && 0 === e.offset && !a
        ? (n += "Z")
        : e.o < 0
        ? ((n += "-"),
          (n += _a(Math.trunc(-e.o / 60))),
          (n += ":"),
          (n += _a(Math.trunc(-e.o % 60))))
        : ((n += "+"),
          (n += _a(Math.trunc(e.o / 60))),
...
const Io = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
  zo = {
    weekNumber: 1,
    weekday: 1,
    hour: 0,
  ...
  Lo = { ordinal: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
...
function qo(e, t) {
  const i = zs(t.zone, ta.defaultZone);
  if (!i.isValid) return Ko.invalid(Oo(i));
  const r = Es.fromObject(t);
  let s, a;
  if (ba(e.year)) s = ta.now();
  else {
    for (const t of Fo) ba(e[t]) && (e[t] = Io[t]);
    const t = pa(e) || ya(e);
    if (t) return Ko.invalid(t);
    const r = (function (e) {
      return (
        Qo[e] || (void 0 === Jo && (Jo = ta.now()), (Qo[e] = e.offset(Jo))),
        Qo[e]
      );
    })(i);
    [s, a] = Uo(e, r, i);
  }
  return new Ko({ ts: s, zone: i, loc: r, o: a });
}
function Ro(e, t, i) {
  const r = !!ba(i.round) || i.round,
    s = (e, s) => {
      e = $a(e, r || i.calendary ? 0 : 2, !0);
      return t.loc.clone(i).relFormatter(i).format(e, s);
    },
    a = (r) =>
      i.calendary
        ? t.hasSame(e, r)
        ...
        : t.diff(e, r).get(r);
  if (i.unit) return s(a(i.unit), i.unit);
...
class Ko {
  constructor(e) {
    const t = e.zone || ta.defaultZone;
    let i =
      e.invalid ||
      (Number.isNaN(e.ts) ? new ia("invalid input") : null) ||
      (t.isValid ? null : Oo(t));
    this.ts = ba(e.ts) ? ta.now() : e.ts;
    let r = null,
      s = null;
    if (!i) {
      if (e.old && e.old.ts === this.ts && e.old.zone.equals(t))
        ...
        const a = ga(e.o) && !e.old ? e.o : t.offset(this.ts);
        (r = Bo(this.ts, a)),
          (i = Number.isNaN(r.year) ? new ia("invalid input") : null),
          (r = i ? null : r),
          (s = i ? null : a);
      }
    }
  ...
  static fromJSDate(e, t = {}) {
    const i = (function (e) {
      ...
      ? e.valueOf()
      : NaN;
    if (Number.isNaN(i)) return Ko.invalid("invalid input");
    const r = zs(t.zone, ta.defaultZone);
    return r.isValid
      ? new Ko({ ts: i, zone: r, loc: Es.fromObject(t) })
      : Ko.invalid(Oo(r));
  }
  static fromMillis(e, t = {}) {
    if (ga(e))
      return e < -No || e > No
        ? Ko.invalid("Timestamp out of range")
        : new Ko({
            ts: e,
            zone: zs(t.zone, ta.defaultZone),
            loc: Es.fromObject(t),
          });
    throw new Hr(
  ...
  static fromObject(e, t = {}) {
    ...
    const r = Es.fromObject(t),
      s = za(e, Wo),
      { minDaysInFirstWeek: a, startOfWeek: n } = fa(s, r),
      o = ta.now(),
      l = ba(t.specificOffset) ? i.offset(o) : t.specificOffset,
      c = !ba(s.ordinal),
      d = !ba(s.year),
      u = !ba(s.month) || !ba(s.day),
      h = d || u,
    ...
    if (u && c) throw new Fr("Can't mix ordinal dates with month/day");
    const f = m || (s.weekday && !h);
    let p,
      y,
      b = Bo(o, l);
    f
      ? ((p = Po), (y = zo), (b = da(b, a, n)))
      : c
      ? ((p = Ho), (y = Lo), (b = ha(b)))
      : ((p = Fo), (y = Io));
    let g = !1;
    for (const e of p) {
      ba(s[e]) ? (s[e] = g ? y[e] : b[e]) : (g = !0);
    }
    const w = f
        ? (function (e, t = 4, i = 1) {
            const r = wa(e.weekYear),
              s = Sa(e.weekNumber, 1, Ga(e.weekYear, t, i)),
              a = Sa(e.weekday, 1, 7);
            return r
              ? s
                ? !a && aa("weekday", e.weekday)
                : aa("week", e.weekNumber)
              : aa("weekYear", e.weekYear);
          })(s, a, n)
        : c
        ? (function (e) {
            const t = wa(e.year),
              i = Sa(e.ordinal, 1, Ca(e.year));
            return t ? !i && aa("ordinal", e.ordinal) : aa("year", e.year);
          })(s)
        : pa(s),
      v = w || ya(s);
    if (v) return Ko.invalid(v);
    const k = f ? ua(s, a, n) : c ? ma(s) : s,
      [x, T] = Uo(k, l, i),
      M = new Ko({ ts: x, zone: i, o: T, loc: r });
    return s.weekday && h && e.weekday !== M.weekday
      ? Ko.invalid(
          "mismatched weekday",
      ...
      : M.isValid
      ? M
      : Ko.invalid(M.invalid);
  }
  static fromISO(e, t = {}) {
    const [i, r] = (function (e) {
      return dn(e, [Gn, In], [En, zn], [Dn, Ln], [jn, Fn]);
    })(e);
    return Go(i, r, t, "ISO 8601", e);
  }
  static fromRFC2822(e, t = {}) {
    ...
    return Go(i, r, t, "RFC 2822", e);
  }
  static fromHTTP(e, t = {}) {
    const [i, r] = (function (e) {
      return dn(e, [Zn, Un], [Cn, Un], [Bn, Vn]);
    })(e);
    return Go(i, r, t, "HTTP", t);
  }
  static fromFormat(e, t, i = {}) {
    ...
    const { locale: r = null, numberingSystem: s = null } = i,
      a = Es.fromOpts({ locale: r, numberingSystem: s, defaultToEN: !0 }),
      [n, o, l, c] = (function (e, t, i) {
        const {
          result: r,
          zone: s,
          specificOffset: a,
    ...
    return c ? Ko.invalid(c) : Go(n, o, i, `format ${t}`, e, l);
  }
  static fromString(e, t, i = {}) {
    return Ko.fromFormat(e, t, i);
  }
  static fromSQL(e, t = {}) {
    const [i, r] = (function (e) {
      return dn(e, [Hn, In], [Wn, qn]);
    })(e);
    return Go(i, r, t, "SQL", e);
  }
  static invalid(e, t = null) {
    if (!e) throw new Hr("need to specify a reason the DateTime is invalid");
    const i = e instanceof ia ? e : new ia(e, t);
    if (ta.throwOnInvalid) throw new Ir(i);
    return new Ko({ invalid: i });
  }
  static isDateTime(e) {
    return (e && e.isLuxonDateTime) || !1;
  }
  static parseFormatForOpts(e, t = {}) {
    const i = So(e, Es.fromObject(t));
    return i ? i.map((e) => (e ? e.val : null)).join("") : null;
  }
  static expandFormat(e, t = {}) {
    return xo(nn.parseFormat(e), Es.fromObject(t))
      .map((e) => e.val)
      .join("");
  }
  static resetCache() {
  ...
  get localWeekNumber() {
    return this.isValid ? $o(this).weekNumber : NaN;
  }
  get localWeekYear() {
    return this.isValid ? $o(this).weekYear : NaN;
  }
  get ordinal() {
  ...
  get monthShort() {
    return this.isValid
      ? lo.months("short", { locObj: this.loc })[this.month - 1]
      : null;
  }
  get monthLong() {
    return this.isValid
      ? lo.months("long", { locObj: this.loc })[this.month - 1]
      : null;
  }
  get weekdayShort() {
    return this.isValid
      ? lo.weekdays("short", { locObj: this.loc })[this.weekday - 1]
      : null;
  }
  get weekdayLong() {
    return this.isValid
      ? lo.weekdays("long", { locObj: this.loc })[this.weekday - 1]
      : null;
  }
  get offset() {
  ...
  getPossibleOffsets() {
    ...
    const e = 864e5,
      ...
      a = this.zone.offset(i - r * t),
      n = this.zone.offset(i - s * t);
    if (a === n) return [this];
    const o = i - a * t,
      l = i - n * t,
      c = Bo(o, a),
  ...
  get daysInYear() {
    return this.isValid ? Ca(this.year) : NaN;
  }
  get weeksInWeekYear() {
  ...
  resolvedLocaleOptions(e = {}) {
    const {
      ...
      numberingSystem: i,
      calendar: r,
    } = nn.create(this.loc.clone(e), e).resolvedOptions(this);
    return { locale: t, numberingSystem: i, outputCalendar: r };
  }
  toUTC(e = 0, t = {}) {
    return this.setZone(js.instance(e), t);
  }
  toLocal() {
    return this.setZone(ta.defaultZone);
  }
  setZone(e, { keepLocalTime: t = !1, keepCalendarTime: i = !1 } = {}) {
    if ((e = zs(e, ta.defaultZone)).equals(this.zone)) return this;
    if (e.isValid) {
      let r = this.ts;
      if (t || i) {
      ...
      return Zo(this, { ts: r, zone: e });
    }
    return Ko.invalid(Oo(e));
  }
  ...
  set(e) {
    if (!this.isValid) return this;
    const t = za(e, Wo),
      { minDaysInFirstWeek: i, startOfWeek: r } = fa(t, this.loc),
      s = !ba(t.weekYear) || !ba(t.weekNumber) || !ba(t.weekday),
      a = !ba(t.ordinal),
      n = !ba(t.year),
      o = !ba(t.month) || !ba(t.day),
      l = n || o,
    ...
    if (o && a) throw new Fr("Can't mix ordinal dates with month/day");
    let d;
    s
      ? (d = ua({ ...da(this.c, i, r), ...t }, i, r))
      : ba(t.ordinal)
      ? ((d = { ...this.toObject(), ...t }),
        ba(t.day) && (d.day = Math.min(Ba(d.year, d.month), d.day)))
      : (d = ma({ ...ha(this.c), ...t }));
    const [u, h] = Uo(d, this.o, this.zone);
    return Zo(this, { ts: u, o: h });
  }
  plus(e) {
    if (!this.isValid) return this;
    return Zo(this, Vo(this, ao.fromDurationLike(e)));
  }
  minus(e) {
    if (!this.isValid) return this;
    return Zo(this, Vo(this, ao.fromDurationLike(e).negate()));
  }
  startOf(e, { useLocaleWeeks: t = !1 } = {}) {
    if (!this.isValid) return this;
    const i = {},
      r = ao.normalizeUnit(e);
    switch (r) {
      case "years":
        i.month = 1;
      case "quarters":
    ...
    if ("weeks" === r)
      if (t) {
        const e = this.loc.getStartOfWeek(),
          { weekday: t } = this;
        t < e && (i.weekNumber = this.weekNumber - 1), (i.weekday = e);
      } else i.weekday = 1;
    if ("quarters" === r) {
  ...
  toFormat(e, t = {}) {
    return this.isValid
      ? nn.create(this.loc.redefaultToEN(t)).formatDateTimeFromString(this, e)
      : _o;
  }
  toLocaleString(e = Jr, t = {}) {
    return this.isValid
      ? nn.create(this.loc.clone(t), e).formatDateTime(this)
      : _o;
  }
  toLocaleParts(e = {}) {
    return this.isValid
      ? nn.create(this.loc.clone(e), e).formatDateTimeParts(this)
      : [];
  }
  toISO({
    format: e = "extended",
    ...
    const a = "extended" === e;
    let n = Do(this, a);
    return (n += "T"), (n += jo(this, a, t, i, r, s)), n;
  }
  toISODate({ format: e = "extended" } = {}) {
    return this.isValid ? Do(this, "extended" === e) : null;
  }
  toISOWeekDate() {
  ...
  toISOTime({
    ...
    if (!this.isValid) return null;
    return (r ? "T" : "") + jo(this, "extended" === a, t, e, i, s);
  }
  toRFC2822() {
  ...
  toSQLDate() {
    return this.isValid ? Do(this, !0) : null;
  }
  toSQLTime({
    includeOffset: e = !0,
    includeZone: t = !1,
  ...
  toString() {
    return this.isValid ? this.toISO() : _o;
  }
  [Symbol.for("nodejs.util.inspect.custom")]() {
    return this.isValid
  ...
  diff(e, t = "milliseconds", i = {}) {
    if (!this.isValid || !e.isValid)
      return ao.invalid("created by diffing an invalid DateTime");
    const r = {
        locale: this.locale,
        numberingSystem: this.numberingSystem,
        ...i,
      },
      s = ((o = t), Array.isArray(o) ? o : [o]).map(ao.normalizeUnit),
      a = e.valueOf() > this.valueOf(),
      n = uo(a ? this : e, a ? e : this, s, r);
    var o;
    return a ? n.negate() : n;
  }
  diffNow(e = "milliseconds", t = {}) {
    return this.diff(Ko.now(), e, t);
  }
  until(e) {
    return this.isValid ? oo.fromDateTimes(this, e) : this;
  }
  hasSame(e, t, i) {
  ...
  toRelative(e = {}) {
    if (!this.isValid) return null;
    const t = e.base || Ko.fromObject({}, { zone: this.zone }),
    ...
    return (
      ...
      Ro(t, this.plus(i), { ...e, numeric: "always", units: r, unit: s })
    );
  }
  toRelativeCalendar(e = {}) {
    return this.isValid
      ? Ro(e.base || Ko.fromObject({}, { zone: this.zone }), this, {
          ...e,
          numeric: "auto",
  ...
  static min(...e) {
    if (!e.every(Ko.isDateTime))
      throw new Hr("min requires all arguments be DateTimes");
    return xa(e, (e) => e.valueOf(), Math.min);
  }
  static max(...e) {
    if (!e.every(Ko.isDateTime))
      throw new Hr("max requires all arguments be DateTimes");
    return xa(e, (e) => e.valueOf(), Math.max);
  }
  static fromFormatExplain(e, t, i = {}) {
    const { locale: r = null, numberingSystem: s = null } = i;
    return Mo(
      Es.fromOpts({ locale: r, numberingSystem: s, defaultToEN: !0 }),
      e,
      t,
    );
  }
  static fromStringExplain(e, t, i = {}) {
    return Ko.fromFormatExplain(e, t, i);
  }
  static buildFormatParser(e, t = {}) {
    const { locale: i = null, numberingSystem: r = null } = t,
      s = Es.fromOpts({ locale: i, numberingSystem: r, defaultToEN: !0 });
    return new To(s, e);
  }
  static fromFormatParser(e, t, i = {}) {
    ...
    return c ? Ko.invalid(c) : Go(n, o, i, `format ${t.format}`, e, l);
  }
...
function Xo(e) {
  ...
  if (e && e.valueOf && ga(e.valueOf())) return Ko.fromJSDate(e);
  if (e && "object" == typeof e) return Ko.fromObject(e);
  throw new Hr(`Unknown datetime argument: ${e}, of type ${typeof e}`);
}
console.info(
...
const el = new Map()
  .set(-20, new ge(0, 60, 98))
  .set(-10, new ge(120, 162, 204))
  .set(0, new ge(164, 195, 210))
  .set(10, new ge(121, 210, 179))
  .set(20, new ge(252, 245, 112))
  .set(30, new ge(255, 150, 79))
  .set(40, new ge(255, 192, 159));
let tl = class extends se {
  constructor() {
    super(), (this.forecastSubscriberLock = !1), (this.currentDate = Ko.now());
    const e = 1e3 - this.currentDate.millisecond;
    setTimeout(
      () =>
        setInterval(() => {
          this.currentDate = Ko.now();
        }, 1e3),
      e,
    ),
      setTimeout(() => {
  ...
  static getStubConfig(e, t, i) {
    const r = t.find((e) => {
      var t;
      return null !== (t = e.startsWith("weather.")) && void 0 !== t
        ? t
        : i.find(() => !0);
    });
    return r ? { entity: r } : {};
  ...
  getCardSize() {
    return 3 + xr(this.config.forecast_rows / 2);
  }
  setConfig(e) {
    if (!e) throw this.createError("Invalid configuration.");
    if (!e.entity)
      throw this.createError('Attribute "entity" must be present.');
    if (e.forecast_rows && e.forecast_rows < 1)
      throw this.createError(
        'Attribute "forecast_rows" must be greater than 0.',
      );
    if (
      e.time_format &&
      "24" !== e.time_format.toString() &&
      "12" !== e.time_format.toString()
    )
      throw this.createError(
        'Attribute "time_format" must either be "12" or "24".',
      );
    if (e.hide_today_section && e.hide_forecast_section)
      throw this.createError(
        'Attributes "hide_today_section" and "hide_forecast_section" must not enabled at the same time.',
      );
    this.config = this.mergeConfig(e);
  }
  shouldUpdate(e) {
    if (!this.config) return !1;
    if (e.has("forecasts")) return !0;
    const t = e.get("hass");
    if (t) {
      if (
        t.states[this.config.sun_entity] !==
        this.hass.states[this.config.sun_entity]
      )
        return !0;
    }
    return (function (e, t, i) {
      if (t.has("config") || i) return !0;
      if (e.config.entity) {
        var r = t.get("hass");
        return (
          !r || r.states[e.config.entity] !== e.hass.states[e.config.entity]
        );
      }
      return !1;
    })(this, e, !1);
  ...
  updated(e) {
    super.updated(e), e.has("config") && this.subscribeForecastEvents();
  }
  render() {
    if (this.error) return this.error;
    const e = !this.config.hide_today_section,
      t = !this.config.hide_forecast_section;
    return D`
      <ha-card
        @action=${(e) => {
          this.handleAction(e);
        ...
        .actionHandler=${Me({
          hasHold: be(this.config.hold_action),
          hasDoubleClick: be(this.config.double_tap_action),
        })}
        tabindex="0"
  ...
  connectedCallback() {
    super.connectedCallback(),
      this.hasUpdated && this.subscribeForecastEvents();
  }
  disconnectedCallback() {
  ...
  willUpdate(e) {
    super.willUpdate(e),
      this.forecastSubscriber || this.subscribeForecastEvents();
  }
  renderToday() {
    const e = this.getWeather(),
      t = e.state,
      i = this.config.show_decimal
        ? this.getCurrentTemperature()
        : Tr(this.getCurrentTemperature()),
      r = e.attributes.temperature_unit,
      s = this.config.show_decimal
        ? this.getApparentTemperature()
        : Tr(this.getApparentTemperature()),
      a = this.getAqi(),
      n = this.getAqiColor(a),
      o = Tr(this.getCurrentHumidity()),
      l = this.config.weather_icon_type,
      c = this.toIcon(t, l, !1, this.getIconAnimationKind()),
      d = this.localize(`weather.${t}`),
      u = null !== i ? this.toConfiguredTempWithUnit(r, i) : null,
      h = null !== o ? `${o}% ${this.localize("misc.humidity")}` : null,
      m = null !== s ? this.toConfiguredTempWithUnit(r, s) : null,
      f = this.localize("misc.feels-like"),
      p = this.localize("misc.aqi");
    return D`
      <clock-weather-card-today-left>
      ...
      <clock-weather-card-today-right>
        <clock-weather-card-today-right-wrap>
          <clock-weather-card-today-right-wrap-top>
            ...
            ${
              this.config.aqi_sensor && null !== a
                ? D`<br><aqi style="background-color: ${n}">${a} ${p}</aqi>`
                : ""
            }
          </clock-weather-card-today-right-wrap-top>
          <clock-weather-card-today-right-wrap-center>
  ...
  renderForecast() {
    const e = this.getWeather(),
      t = Tr(this.getCurrentTemperature()),
      i = this.config.forecast_rows,
      r = this.config.hourly_forecast,
      s = e.attributes.temperature_unit,
      a = this.mergeForecasts(i, r),
      n = a.map((e) => e.templow),
      o = a.map((e) => e.temperature);
    null !== t && (n.push(t), o.push(t));
    const l = Math.round(vr(n)),
      c = Math.round(wr(o)),
      d = this.gradientRange(l, c, s),
      u = a
        .map((e) => e.datetime)
        .map((e) => (r ? this.time(e) : this.localize(`day.${e.weekday}`))),
      h = u.length ? wr(u.map((e) => e.length)) : 0;
    return a.map((e, i) =>
      Dr(() => this.renderForecastItem(e, d, l, c, t, r, u[i], h)),
    );
  }
  renderForecastItem(e, t, i, r, s, a, n, o) {
    const l =
        "pouring" === e.condition
          ? "raindrops"
          : "rainy" === e.condition
          ? "raindrop"
          : e.condition,
      c = this.toIcon(l, "fill", !0, "static"),
      d = this.getWeather().attributes.temperature_unit,
      u = a
        ? Ko.now().hour === e.datetime.hour
        : Ko.now().day === e.datetime.day,
      h = Math.round(u && null !== s ? Math.min(s, e.templow) : e.templow),
      m = Math.round(
        u && null !== s ? Math.max(s, e.temperature) : e.temperature,
      );
    return D`
      <clock-weather-card-forecast-row style="--col-one-size: ${0.5 * o}rem;">
        ${this.renderText(n)}
        ${this.renderIcon(c)}
  ...
  renderForecastTemperatureBar(e, t, i, r, s, a, n) {
    const { startPercent: o, endPercent: l } = this.calculateBarRangePercents(
      t,
      i,
      r,
      s,
    ...
    return D`
      <forecast-temperature-bar>
        ...
        <forecast-temperature-bar-range
          style="--move-right: ${
            i === t ? 0 : (r - t) / (i - t)
          }; --start-percent: ${o}%; --end-percent: ${l}%; --gradient: ${this.gradient(
            e,
            o,
            l,
          )};"
  ...
  renderForecastCurrentTemp(e, t, i) {
    if (null == i) return D``;
    return D`
      <forecast-temperature-bar-current-indicator style="--position: ${
        e === t ? 0 : (100 / (t - e)) * (i - e)
      }%;">
        <forecast-temperature-bar-current-indicator-dot style="--move-right: ${
          t === e ? 0 : (i - e) / (t - e)
        }">
        </forecast-temperature-bar-current-indicator-dot>
      </forecast-temperature-bar-current-indicator>
  ...
  gradientRange(e, t, i) {
    const r = this.toCelsius(i, e),
      s = this.toCelsius(i, t),
      a = Math.max(
        (function (e, t = 0) {
          return t <= 0 ? Math.floor(e) : Math.floor(e / t) * t;
        })(r, 10),
        vr([...el.keys()]),
      ),
      n = Math.min(xr(s, 10), wr([...el.keys()]));
  ...
  gradient(e, t, i) {
    var r;
    if (e.length <= 1) {
      const t = null !== (r = e[0]) && void 0 !== r ? r : new ge(255, 255, 255);
      return [t, t].map((e) => e.toRgbString()).join(",");
    }
    const [s, a] = this.calculateRgb(e, t, "left"),
      [n, o] = this.calculateRgb(e, i, "right");
    return [s, ...e.slice(a + 1, o), n].map((e) => e.toRgbString()).join(",");
  }
  calculateRgb(e, t, i) {
    function r(e, t, i) {
      const r = (Math.abs(e - t) / 100) * i;
      return kr(e > t ? e - r : e + r);
    }
    ...
    return [c, "left" === i ? Math.min(n, l) : Math.max(n, l)];
  }
  handleAction(e) {
    this.hass &&
      this.config &&
      ...
      (function (e, t, i, r) {
        var s;
        "double_tap" === r && i.double_tap_action
          ? (s = i.double_tap_action)
          : "hold" === r && i.hold_action
          ? (s = i.hold_action)
          : "tap" === r && i.tap_action && (s = i.tap_action),
          ye(e, t, i, s);
      })(this, this.hass, this.config, e.detail.action);
  }
  mergeConfig(e) {
    var t, i, r, s, a, n, o, l, c, d, u, h, m, f, p, y, b, g;
    return Object.assign(Object.assign({}, e), {
      sun_entity: null !== (t = e.sun_entity) && void 0 !== t ? t : "sun.sun",
      temperature_sensor: e.temperature_sensor,
      humidity_sensor: e.humidity_sensor,
      weather_icon_type:
        null !== (i = e.weather_icon_type) && void 0 !== i ? i : "line",
      forecast_rows: null !== (r = e.forecast_rows) && void 0 !== r ? r : 5,
      hourly_forecast: null !== (s = e.hourly_forecast) && void 0 !== s && s,
      animated_icon: null === (a = e.animated_icon) || void 0 === a || a,
      time_format:
        null === (n = e.time_format) || void 0 === n ? void 0 : n.toString(),
      time_pattern: null !== (o = e.time_pattern) && void 0 !== o ? o : void 0,
      show_humidity: null !== (l = e.show_humidity) && void 0 !== l && l,
      hide_forecast_section:
        null !== (c = e.hide_forecast_section) && void 0 !== c && c,
      hide_today_section:
        null !== (d = e.hide_today_section) && void 0 !== d && d,
      hide_clock: null !== (u = e.hide_clock) && void 0 !== u && u,
      hide_date: null !== (h = e.hide_date) && void 0 !== h && h,
      date_pattern: null !== (m = e.date_pattern) && void 0 !== m ? m : "D",
      use_browser_time: null !== (f = e.use_browser_time) && void 0 !== f && f,
      time_zone: null !== (p = e.time_zone) && void 0 !== p ? p : void 0,
      show_decimal: null !== (y = e.show_decimal) && void 0 !== y && y,
      apparent_sensor:
        null !== (b = e.apparent_sensor) && void 0 !== b ? b : void 0,
      aqi_sensor: null !== (g = e.aqi_sensor) && void 0 !== g ? g : void 0,
    });
  }
  toIcon(e, t, i, r) {
    var s;
    const a = i
        ? "day"
        : "below_horizon" ===
          (null === (s = this.getSun()) || void 0 === s ? void 0 : s.state)
        ? "night"
        : "day",
      n = ("animated" === r ? Gr : Er)[t][e];
    return (null == n ? void 0 : n[a]) || n;
  }
  getWeather() {
    const e = this.hass.states[this.config.entity];
    if (!e)
      throw this.createError(
        `Weather entity "${this.config.entity}" could not be found.`,
      );
    return e;
  }
  getCurrentTemperature() {
    ...
    if (this.config.temperature_sensor) {
      const t = this.hass.states[this.config.temperature_sensor],
        i = (null == t ? void 0 : t.state) ? parseFloat(t.state) : void 0,
        r =
          null !==
            (e = null == t ? void 0 : t.attributes.unit_of_measurement) &&
          void 0 !== e
            ? e
            : this.getConfiguredTemperatureUnit();
      if (void 0 !== i && !isNaN(i))
        return this.toConfiguredTempWithoutUnit(r, i);
    }
    return null !== (t = this.getWeather().attributes.temperature) &&
      void 0 !== t
      ? t
      : null;
  }
  getCurrentHumidity() {
    ...
    if (this.config.humidity_sensor) {
      const e = this.hass.states[this.config.humidity_sensor],
        t = (null == e ? void 0 : e.state) ? parseFloat(e.state) : void 0;
      if (void 0 !== t && !isNaN(t)) return t;
    }
    return null !== (e = this.getWeather().attributes.humidity) && void 0 !== e
      ? e
      : null;
  }
  getApparentTemperature() {
    ...
    if (this.config.apparent_sensor) {
      const t = this.hass.states[this.config.apparent_sensor],
        i = (null == t ? void 0 : t.state) ? parseFloat(t.state) : void 0,
        r =
          null !==
            (e = null == t ? void 0 : t.attributes.unit_of_measurement) &&
  ...
  getAqi() {
    if (this.config.aqi_sensor) {
      const e = this.hass.states[this.config.aqi_sensor],
        t = (null == e ? void 0 : e.state) ? parseInt(e.state) : void 0;
      if (void 0 !== t && !isNaN(t)) return t;
    }
    return null;
  }
  ...
  getLocale() {
    ...
    return null !==
      (t =
        null !== (e = this.config.locale) && void 0 !== e
          ? e
          : this.hass.locale.language) && void 0 !== t
      ? t
      : "en-GB";
  }
  date() {
    return this.toZonedDate(this.currentDate).toFormat(
      this.config.date_pattern,
    );
  }
  time(e = this.currentDate) {
    return this.config.time_pattern
      ? this.toZonedDate(e).toFormat(this.config.time_pattern)
      : this.config.time_format
      ? this.toZonedDate(e).toFormat(
          "24" === this.config.time_format ? "HH:mm" : "h:mm a",
        )
      : this.hass.locale.time_format === he.am_pm
      ? this.toZonedDate(e).toFormat("h:mm a")
      : this.hass.locale.time_format === he.twenty_four
      ? this.toZonedDate(e).toFormat("HH:mm")
      : this.toZonedDate(e).toFormat("t");
  }
  getIconAnimationKind() {
    return this.config.animated_icon ? "animated" : "static";
  }
  toCelsius(e, t) {
    return "°C" === e ? t : Math.round((5 / 9) * (t - 32));
  }
  toFahrenheit(e, t) {
    return "°F" === e ? t : Math.round((9 * t) / 5 + 32);
  }
  getConfiguredTemperatureUnit() {
    return this.hass.config.unit_system.temperature;
  }
  toConfiguredTempWithUnit(e, t) {
    return (
      this.toConfiguredTempWithoutUnit(e, t) +
      this.getConfiguredTemperatureUnit()
    );
  }
  toConfiguredTempWithoutUnit(e, t) {
    return this.getConfiguredTemperatureUnit() === e
      ? t
      : "°C" === e
      ? this.toFahrenheit(e, t)
      : this.toCelsius(e, t);
  }
  calculateBarRangePercents(e, t, i, r) {
    if (t === e) return { startPercent: 0, endPercent: 100 };
    const s = (100 / (t - e)) * (i - e),
      a = (100 / (t - e)) * (r - e);
    return { startPercent: Math.max(0, s), endPercent: Math.min(100, a) };
  }
  localize(e) {
    return (function (e, t) {
      let i;
      const r = t
        ...
        .toLowerCase();
      try {
        i = e.split(".").reduce((e, t) => e[t], gr[r]);
      } catch (t) {
        i = e.split(".").reduce((e, t) => e[t], gr.en);
      }
      return (
        void 0 === i && (i = e.split(".").reduce((e, t) => e[t], gr.en)), i
      );
    })(e, this.getLocale());
  }
  mergeForecasts(e, t) {
    ...
    const s = (
      this.isLegacyWeather()
        ? null !== (i = this.getWeather().attributes.forecast) && void 0 !== i
          ? i
          : []
        : null !== (r = this.forecasts) && void 0 !== r
        ? r
        : []
    ).reduce((e, i) => {
      const r = new Date(i.datetime),
        s = t ? `${r.getMonth()}-${r.getDate()}-${+r.getHours()}` : r.getDate();
      return (e[s] = e[s] || []), e[s].push(i), e;
    }, {});
    return Object.values(s)
      .reduce((e, t) => {
        if (0 === t.length) return e;
        const i = this.calculateAverageForecast(t);
        return e.push(i), e;
      }, [])
      .sort((e, t) => e.datetime.toMillis() - t.datetime.toMillis())
      .slice(0, e);
  }
  toZonedDate(e) {
    var t, i, r;
    const s = e.setLocale(this.getLocale());
    if (this.config.use_browser_time) return s;
    const a =
        null !== (t = this.config.time_zone) && void 0 !== t
          ? t
          : null ===
              (r =
                null === (i = this.hass) || void 0 === i ? void 0 : i.config) ||
            void 0 === r
          ? void 0
          : r.time_zone,
      n = s.setZone(a);
    return n.isValid
      ? n
      : (console.error(
          `clock-weather-card - Time Zone [${a}] not supported. Falling back to browser time.`,
        ),
        s);
  }
  calculateAverageForecast(e) {
    const t = e.map((e) => {
        var t, i, r;
        return null !==
          (r =
            null !==
              (i =
                null !== (t = e.templow) && void 0 !== t ? t : e.temperature) &&
            void 0 !== i
              ? i
              : this.getCurrentTemperature()) && void 0 !== r
          ? r
          : 0;
      }),
      i = vr(t),
      r = e.map((e) => {
        ...
        return null !==
          (i =
            null !== (t = e.temperature) && void 0 !== t
              ? t
              : this.getCurrentTemperature()) && void 0 !== i
          ? i
          : 0;
      }),
      s = wr(r),
      a = e.map((e) => {
        var t;
        return null !== (t = e.precipitation_probability) && void 0 !== t
          ? t
          : 0;
      }),
      n = wr(a),
      o = e.map((e) => {
        var t;
        return null !== (t = e.precipitation) && void 0 !== t ? t : 0;
      }),
      l = wr(o),
      c = e.map((e) => e.condition),
      d = (function (e) {
        var t, i, r;
        const s = new Map();
        let a = e[0],
        ...
        for (let o = 0; o < e.length; o++) {
          const l = e[o];
          if (void 0 === s.get(l)) s.set(l, 1);
          else {
            const e = null !== (t = s.get(l)) && void 0 !== t ? t : 0;
            s.set(l, e + 1),
              (null !== (i = s.get(l)) && void 0 !== i ? i : 0) > n &&
                ((a = l),
                (n = null !== (r = s.get(l)) && void 0 !== r ? r : 0));
          }
        }
        return a;
      })(c);
    return {
      temperature: s,
      templow: i,
      datetime: this.parseDateTime(e[0].datetime),
      condition: d,
  ...
  subscribeForecastEvents() {
    return t(this, void 0, void 0, function* () {
      ...
      if (
        ((this.forecastSubscriberLock = !0),
        yield this.unsubscribeForecastEvents(),
        this.isLegacyWeather())
      )
        return (
          (this.forecastSubscriber = () =>
            t(this, void 0, void 0, function* () {})),
          void (this.forecastSubscriberLock = !1)
        );
      if (!this.isConnected || !this.config || !this.hass)
        return void (this.forecastSubscriberLock = !1);
      const e = this.determineForecastType();
      if ("hourly_not_supported" === e)
        throw (
          ((this.forecastSubscriber = () =>
            t(this, void 0, void 0, function* () {})),
          (this.forecastSubscriberLock = !1),
          this.createError(
            `Weather entity [${this.config.entity}] does not support hourly forecast.`,
          ))
        );
      try {
        const t = (e) => {
            this.forecasts = e.forecast;
          },
          i = { resubscribe: !1 },
          r = {
        ...
        this.forecastSubscriber = yield this.hass.connection.subscribeMessage(
          t,
          r,
          i,
        );
        ...
        console.error(
          "clock-weather-card - Error when subscribing to weather forecast",
          e,
        );
      } finally {
        this.forecastSubscriberLock = !1;
  ...
  unsubscribeForecastEvents() {
    return t(this, void 0, void 0, function* () {
      if (this.forecastSubscriber)
        try {
          yield this.forecastSubscriber();
        } catch (e) {
        } finally {
          this.forecastSubscriber = void 0;
        }
    });
  }
  isLegacyWeather() {
    return !this.supportsFeature(1) && !this.supportsFeature(2);
  }
  supportsFeature(e) {
    try {
      return !!(this.getWeather().attributes.supported_features & e);
    } catch (e) {
      return !1;
    }
  }
  createError(e) {
    ...
    return (
      i.setConfig({ type: "error", error: t, origConfig: this.config }),
      (this.error = D`${i}`),
      t
    );
  }
  determineForecastType() {
    const e = this.supportsFeature(1),
      t = this.supportsFeature(2),
      i = this.config.hourly_forecast;
    return e && t
      ? i
        ? "hourly"
        : "daily"
  ...
  parseDateTime(e) {
    const t = Ko.fromISO(e);
    return t.isValid ? t : Ko.fromJSDate(new Date(e));
  }
};
e([le({ attribute: !1 })], tl.prototype, "hass", void 0),
  e([ce()], tl.prototype, "config", void 0),
  e([ce()], tl.prototype, "currentDate", void 0),
  e([ce()], tl.prototype, "forecasts", void 0),
  e([ce()], tl.prototype, "error", void 0),
  (tl = e(
    [
      ((e) => (t) =>
        "function" == typeof t
          ...
          : ((e, t) => {
            ...
            })(e, t))("clock-weather-card"),
    ],
    tl,
  ));
export { tl as ClockWeatherCard };
